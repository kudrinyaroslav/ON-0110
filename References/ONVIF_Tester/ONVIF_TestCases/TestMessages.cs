...
namespace ONVIF_TestCases
{
    ...
    public class TestMessages
    {
        ...
        #region Media Management Requests

        /// <summary>
        /// Build Stream URI request message
        /// </summary>
        /// <param name="ProfileToken">Profile Token</param>
        /// <param name="StreamSetup">Stream Setup</param>
        /// <returns>SOAP Message containing a Stream URI request</returns>
        public string Build_Media_GetStreamUriRequest(string ProfileToken, Media.StreamSetup StreamSetup)
        {
            string soapMessage = "";

            // GetStreamUriRequest is a trt:GetStreamUri
            Media.GetStreamUri GetStreamUriRequest = new Media.GetStreamUri();
            // add any perameters
            GetStreamUriRequest.ProfileToken = ProfileToken;
            GetStreamUriRequest.StreamSetup = StreamSetup;
            // build the soap message
            soapMessage = BuildSoap(GetStreamUriRequest);
        ...
        public string Build_Media_GetStreamUriRequest(Media.GetStreamUri GetStreamUriRequest)
        {
            return Build_Media_GetStreamUriRequest(GetStreamUriRequest.ProfileToken, GetStreamUriRequest.StreamSetup);
        }

        /// <summary>
        /// Build Set Video Encoder Configuration Request
        /// </summary>
        /// <param name="Configuration">Configuration</param>
        /// <param name="ForcePersistence">Force Persistance</param>
        /// <returns>SOAP Message containing a Set Video Encoder Configuration Request</returns>
        public string Build_Media_SetVideoEncoderConfigurationRequest(Media.VideoEncoderConfiguration Configuration, bool ForcePersistence)
        {
            string soapMessage = "";

            // SetVideoEncoderConfigurationRequest is a trt:SetVideoEncoderConfiguration
            Media.SetVideoEncoderConfiguration SetVideoEncoderConfigurationRequest = new Media.SetVideoEncoderConfiguration();
            // add any perameters
            SetVideoEncoderConfigurationRequest.Configuration = Configuration;
            SetVideoEncoderConfigurationRequest.ForcePersistence = ForcePersistence;
            // build the soap message
            soapMessage = BuildSoap(SetVideoEncoderConfigurationRequest);

            return soapMessage;
        }

        public string Build_Media_SetVideoEncoderConfigurationRequest(Media.SetVideoEncoderConfiguration SetVideoEncoderConfigurationRequest)
        {
            return Build_Media_SetVideoEncoderConfigurationRequest(SetVideoEncoderConfigurationRequest.Configuration, SetVideoEncoderConfigurationRequest.ForcePersistence);
        }

        /// <summary>
        /// Build a Get Video Encoder Configuration Request
        /// </summary>
        /// <param name="ConfigurationToken">Configuration Token</param>
        /// <returns>SOAP message containing a Get Video Encoder Configuration Request</returns>
        public string Build_Media_GetVideoEncoderConfigurationRequest(string ConfigurationToken)
        {
            string soapMessage = "";

            // GetVideoEncoderConfigurationRequest is a trt:trt:GetVideoEncoderConfiguration
            Media.GetVideoEncoderConfiguration GetVideoEncoderConfigurationRequest = new Media.GetVideoEncoderConfiguration();
            // add any perameters
            GetVideoEncoderConfigurationRequest.ConfigurationToken = ConfigurationToken;
            // build the soap message
            soapMessage = BuildSoap(GetVideoEncoderConfigurationRequest);

            return soapMessage;
        }

        public string Build_Media_GetVideoEncoderConfigurations()
        {
            string soapMessage = "";

            // GetVideoEncoderConfigurationRequest is a trt:trt:GetVideoEncoderConfiguration
            Media.GetVideoEncoderConfigurations GetVideoEncoderConfigurationsRequest = new Media.GetVideoEncoderConfigurations();
            // add any perameters
            
            // build the soap message
            soapMessage = BuildSoap(GetVideoEncoderConfigurationsRequest);

            return soapMessage;

        }

        public string Build_Media_GetVideoEncoderConfigurationOptions(string ConfigurationToken, string ProfileToken)
        {
            string soapMessage = "";

            // GetVideoEncoderConfigurationRequest is a trt:trt:GetVideoEncoderConfiguration
            Media.GetVideoEncoderConfigurationOptions GetVideoEncoderConfigurationOptionsRequest = new Media.GetVideoEncoderConfigurationOptions();
            // add any perameters
            if(ConfigurationToken != "")
                GetVideoEncoderConfigurationOptionsRequest.ConfigurationToken = ConfigurationToken;
            if (ProfileToken != "") 
                GetVideoEncoderConfigurationOptionsRequest.ProfileToken = ProfileToken;
            // build the soap message
            soapMessage = BuildSoap(GetVideoEncoderConfigurationOptionsRequest);

            return soapMessage;

        }

        public string Build_Media_GetVideoSourceConfigurations()
        {
            string soapMessage = "";

            // GetVideoEncoderConfigurationRequest is a trt:trt:GetVideoEncoderConfiguration
            Media.GetVideoSourceConfigurations GetVideoSourceConfigurations = new Media.GetVideoSourceConfigurations();
            // add any perameters
            
            // build the soap message
            soapMessage = BuildSoap(GetVideoSourceConfigurations);
        ...
        /// <summary>
        /// Build a Delete Profile Request
        /// </summary>
        /// <param name="ProfileToken">Profile Token</param>
        /// <returns>SOAP Message</returns>
        public string Build_Media_DeleteProfileRequest(string ProfileToken)
        {
            string soapMessage = "";

            // DeleteProfileRequest is a trt:DeleteProfile
            Media.DeleteProfile DeleteProfileRequest = new Media.DeleteProfile();
            // add any perameters
            DeleteProfileRequest.ProfileToken = ProfileToken;
            // build the soap message
            soapMessage = BuildSoap(DeleteProfileRequest);

            return soapMessage;
        }

        /// <summary>
        /// Build a Remove Video Source Configuration Request
        /// </summary>
        /// <param name="ProfileToken">Profile Token</param>
        /// <returns>SOAP Message</returns>
        public string Build_Media_RemoveVideoSourceConfigurationRequest(string ProfileToken)
        {
            string soapMessage = "";

            // RemoveVideoSourceConfigurationRequest is a trt:RemoveVideoSourceConfiguration
            Media.RemoveVideoSourceConfiguration RemoveVideoSourceConfigurationRequest = new Media.RemoveVideoSourceConfiguration();
            // add any perameters
            RemoveVideoSourceConfigurationRequest.ProfileToken = ProfileToken;
            // build the soap message
            soapMessage = BuildSoap(RemoveVideoSourceConfigurationRequest);

            return soapMessage;
        }

        /// <summary>
        /// Build a Remove Video Encoder Configuration Request
        /// </summary>
        /// <param name="ProfileToken">Profile Token</param>
        /// <returns>SOAP Message</returns>
        public string Build_Media_RemoveVideoEncoderConfigurationRequest(string ProfileToken)
        {
            string soapMessage = "";

            // RemoveVideoEncoderConfigurationRequest is a trt:RemoveVideoEncoderConfiguration
            Media.RemoveVideoEncoderConfiguration RemoveVideoEncoderConfigurationRequest = new Media.RemoveVideoEncoderConfiguration();
            // add any perameters
            RemoveVideoEncoderConfigurationRequest.ProfileToken = ProfileToken;
            // build the soap message
            soapMessage = BuildSoap(RemoveVideoEncoderConfigurationRequest);

            return soapMessage;
        }

        /// <summary>
        /// Build a Add Video Encoder Configuration Request
        /// </summary>
        /// <param name="ConfigurationToken">Configuration Token</param>
        /// <param name="ProfileToken">ProfileT oken</param>
        /// <returns>SOAP Message</returns>
        public string Build_Media_AddVideoEncoderConfigurationRequest(string ConfigurationToken, string ProfileToken)
        {
            string soapMessage = "";

            // AddVideoEncoderConfigurationRequest is a trt:AddVideoEncoderConfiguration
            Media.AddVideoEncoderConfiguration AddVideoEncoderConfigurationRequest = new Media.AddVideoEncoderConfiguration();
            // add any perameters
            AddVideoEncoderConfigurationRequest.ConfigurationToken = ConfigurationToken;
            AddVideoEncoderConfigurationRequest.ProfileToken = ProfileToken;
            // build the soap message
            soapMessage = BuildSoap(AddVideoEncoderConfigurationRequest);

            return soapMessage;
        }

        /// <summary>
        /// Build a Add Video Source Configuration Request
        /// </summary>
        /// <param name="ConfigurationToken">Configuration Token</param>
        /// <param name="ProfileToken">Profile Token</param>
        /// <returns>SOAP Message</returns>
        public string Build_Media_AddVideoSourceConfigurationRequest(string ConfigurationToken, string ProfileToken)
        {
            string soapMessage = "";

            // AddVideoSourceConfigurationRequest is a trt:AddVideoSourceConfiguration
            Media.AddVideoSourceConfiguration AddVideoSourceConfigurationRequest = new Media.AddVideoSourceConfiguration();
            // add any perameters
            AddVideoSourceConfigurationRequest.ConfigurationToken = ConfigurationToken;
            AddVideoSourceConfigurationRequest.ProfileToken = ProfileToken;
            // build the soap message
            soapMessage = BuildSoap(AddVideoSourceConfigurationRequest);

            return soapMessage;
        }

        /// <summary>
        /// Build a Create Profile Request
        /// </summary>
        /// <param name="Name">Name</param>
        /// <param name="Token">Token</param>
        /// <returns>SOAP Message</returns>
        public string Build_Media_CreateProfileRequest(string Name, string Token)
        {
            string soapMessage = "";

            // CreateProfileRequest is a trt:CreateProfile
            Media.CreateProfile CreateProfileRequest = new Media.CreateProfile();
            // add any perameters
            CreateProfileRequest.Name = Name;
            CreateProfileRequest.Token = Token;
            // build the soap message
            soapMessage = BuildSoap(CreateProfileRequest);

            return soapMessage;
        }

        /// <summary>
        /// Build a Get Profiles Request
        /// </summary>
        /// <param name="ProfileToken">Profile Token</param>
        /// <returns>SOAP Message</returns>
        public string Build_Media_GetProfilesRequest()
        {
            string soapMessage = "";

            // GetProfilesRequest is a trt:trt:GetProfiles
            Media.GetProfiles GetProfilesRequest = new Media.GetProfiles();
            // add any perameters
            // build the soap message
            soapMessage = BuildSoap(GetProfilesRequest);

            return soapMessage;
        }

        /// <summary>
        /// Build a Get Profile Request
        /// </summary>
        /// <param name="ProfileToken">Profile Token</param>
        /// <returns>SOAP Message</returns>
        public string Build_Media_GetProfileRequest(string ProfileToken)
        {
            string soapMessage = "";

            // GetProfileRequest is a trt:GetProfile
            Media.GetProfile GetProfileRequest = new Media.GetProfile();
            // add any perameters
            GetProfileRequest.ProfileToken = ProfileToken;            
            // build the soap message
            soapMessage = BuildSoap(GetProfileRequest);

            return soapMessage;
        }
#endregion

        #region Device Management Requests

        /// <summary>
        /// Build a System Reboot Request
        /// </summary>
        /// <returns>SOAP Message</returns>
        public string Build_SystemRebootRequest()
        {
            string soapMessage = "";

            // SystemRebootRequest is a tds:SystemReboot
            DeviceManagement.SystemReboot SystemRebootRequest = new DeviceManagement.SystemReboot();
            // add any perameters
            
            // build the soap message
            soapMessage = BuildSoap(SystemRebootRequest);

            return soapMessage;
        }

        /// <summary>
        /// Build a Set System Factory Default Request
        /// </summary>
        /// <param name="FactoryDefault">Factory Default</param>
        /// <returns>SOAP Message</returns>
        public string Build_SetSystemFactoryDefaultRequest(DeviceManagement.FactoryDefaultType FactoryDefault)
        {
            string soapMessage = "";

            // SetSystemFactoryDefaultRequest is a tds:SetSystemFactoryDefault
            DeviceManagement.SetSystemFactoryDefault SetSystemFactoryDefaultRequest = new DeviceManagement.SetSystemFactoryDefault();
            // add any perameters
            SetSystemFactoryDefaultRequest.FactoryDefault = FactoryDefault;
            // build the soap message
            soapMessage = BuildSoap(SetSystemFactoryDefaultRequest);

            return soapMessage;
        }

        /// <summary>
        /// Build a Set System Date And Time Request
        /// </summary>
        /// <param name="DateTimeType">Date Time Type</param>
        /// <param name="DaylightSavings">Day light Savings</param>
        /// <param name="TimeZone">Time Zone</param>
        /// <param name="UTCDateTime">UTC Date Time</param>
        /// <returns>SOAP Message</returns>
        public string Build_SetSystemDateAndTimeRequest(DeviceManagement.SetDateTimeType DateTimeType, 
                                                        bool DaylightSavings,
                                                        DeviceManagement.TimeZone TimeZone,
                                                        DeviceManagement.DateTime UTCDateTime)
        {
            string soapMessage = "";

            // SetSystemDateAndTimeRequest is a tds:SetSystemDateAndTime
            DeviceManagement.SetSystemDateAndTime SetSystemDateAndTimeRequest = new DeviceManagement.SetSystemDateAndTime();
            // add any perameters
            SetSystemDateAndTimeRequest.DateTimeType = DateTimeType;
            SetSystemDateAndTimeRequest.DaylightSavings = DaylightSavings;
            SetSystemDateAndTimeRequest.TimeZone = TimeZone;
            SetSystemDateAndTimeRequest.UTCDateTime = UTCDateTime;
            // build the soap message
            soapMessage = BuildSoap(SetSystemDateAndTimeRequest);

            return soapMessage;
        }

        public string Build_SetSystemDateAndTimeRequest(DeviceManagement.SetSystemDateAndTime SetSystemDateAndTimeRequest)
        {

            return Build_SetSystemDateAndTimeRequest(SetSystemDateAndTimeRequest.DateTimeType, 
                                                     SetSystemDateAndTimeRequest.DaylightSavings,
                                                     SetSystemDateAndTimeRequest.TimeZone,
                                                     SetSystemDateAndTimeRequest.UTCDateTime);
        }

        /// <summary>
        /// Build Get System Date And Time Request
        /// </summary>
        /// <returns>SOAP Message</returns>
        public string Build_GetSystemDateAndTimeRequest()
        {
            string soapMessage = "";

            // GetSystemDateAndTimeRequest is a tds:GetSystemDateAndTime
            DeviceManagement.GetSystemDateAndTime GetSystemDateAndTimeRequest = new DeviceManagement.GetSystemDateAndTime();
            // add any perameters
            
            // build the soap message
            soapMessage = BuildSoap(GetSystemDateAndTimeRequest);

            return soapMessage;
        }

        /// <summary>
        /// Build Get Device Information Request
        /// </summary>
        /// <returns>SOAP Message</returns>
        public string Build_GetDeviceInformationRequest()
        {
            string soapMessage = "";

            // GetDeviceInformationRequest is a tds:GetDeviceInformation
            DeviceManagement.GetDeviceInformation GetDeviceInformationRequest = new DeviceManagement.GetDeviceInformation();
            // add any perameters
            
            // build the soap message
            soapMessage = BuildSoap(GetDeviceInformationRequest);

            return soapMessage;
        }

        /// <summary>
        /// Build a Set NTP Request
        /// </summary>
        /// <param name="FromDHCP">From DHCP</param>
        /// <param name="NTPManual">NTP Manual</param>
        /// <returns>SOAP Message</returns>
        public string Build_SetNTPRequest(bool FromDHCP, DeviceManagement.NetworkHost[] NTPManual)
        {
            string soapMessage = "";

            // SetNTPRequest is a tds:SetNTP
            DeviceManagement.SetNTP SetNTPRequest = new DeviceManagement.SetNTP();
            // add any perameters
            SetNTPRequest.FromDHCP = FromDHCP;
            SetNTPRequest.NTPManual = NTPManual;
            // build the soap message
            soapMessage = BuildSoap(SetNTPRequest);

            return soapMessage;
        }

        /// <summary>
        /// Build a Get NTP Request
        /// </summary>
        /// <returns>SOAP Message</returns>
        public string Build_GetNTPRequest()
        {
            string soapMessage = "";

            // GetNTPRequest is a tds:GetNTP
            DeviceManagement.GetNTP GetNTPRequest = new DeviceManagement.GetNTP();
            // add any perameters
            
            // build the soap message
            soapMessage = BuildSoap(GetNTPRequest);

            return soapMessage;
        }

        /// <summary>
        /// Build a Set DNS Request
        /// </summary>
        /// <param name="DNSManual">DNS Manual</param>
        /// <param name="SearchDomain">Search Domain</param>
        /// <returns>SOAP Message</returns>
        public string Build_SetDNSRequest(DeviceManagement.IPAddress[] DNSManual, string[] SearchDomain)
        {
            string soapMessage = "";

            // SetDNSRequest is a tds:SetDNS
            DeviceManagement.SetDNS SetDNSRequest = new DeviceManagement.SetDNS();
            // add any perameters
            SetDNSRequest.DNSManual = DNSManual;
            SetDNSRequest.SearchDomain = SearchDomain; 
            // build the soap message
            soapMessage = BuildSoap(SetDNSRequest);

            return soapMessage;
        }

        public string Build_SetDPAddresses(DeviceManagement.NetworkHost[] DPAddress)
        {
            string soapMessage = "";

            DeviceManagement.SetDPAddresses SetDPAddresses = new DeviceManagement.SetDPAddresses();

            // add any perameters
            SetDPAddresses.DPAddress = DPAddress;

            // build the soap message
            soapMessage = BuildSoap(SetDPAddresses);

            return soapMessage;

        }

        public string Build_GetNetworkInterfaces()
        {
            string soapMessage = "";

            DeviceManagement.GetNetworkInterfaces GetNetworkInterfaces = new DeviceManagement.GetNetworkInterfaces();

            // add any perameters

            // build the soap message
            soapMessage = BuildSoap(GetNetworkInterfaces);

            return soapMessage;

        }

        public string Build_SetNetworkInterfaces(string InterfaceToken, DeviceManagement.NetworkInterfaceSetConfiguration NetworkInterface)
        {
            string soapMessage = "";

            DeviceManagement.SetNetworkInterfaces SetNetworkInterfaces = new DeviceManagement.SetNetworkInterfaces();

            // add any perameters
            SetNetworkInterfaces.InterfaceToken = InterfaceToken;
            SetNetworkInterfaces.NetworkInterface = NetworkInterface;

            // build the soap message
            soapMessage = BuildSoap(SetNetworkInterfaces);
        ...
        /// <summary>
        /// Build a Get DNS Request
        /// </summary>
        /// <returns>SOAP Message</returns>
        public string Build_GetDNSRequest()
        {
            string soapMessage = "";

            // GetDNSRequest is a tds:GetDNS
            DeviceManagement.GetDNS GetDNSRequest = new DeviceManagement.GetDNS();
            // add any perameters
            
            // build the soap message
            soapMessage = BuildSoap(GetDNSRequest);

            return soapMessage;
        }

        /// <summary>
        /// Build a Set Hostname Request
        /// </summary>
        /// <param name="Name">Name</param>
        /// <returns>SOAP Message</returns>
        public string Build_SetHostnameRequest(string Name)
        {
            string soapMessage = "";

            // SetHostnameRequest is a tds:SetHostname
            DeviceManagement.SetHostname SetHostnameRequest = new DeviceManagement.SetHostname();
            // add any perameters
            SetHostnameRequest.Name = Name;
            // build the soap message
            soapMessage = BuildSoap(SetHostnameRequest);

            return soapMessage;
        }

        /// <summary>
        /// Build a Get Hostname Request
        /// </summary>
        /// <returns>SOAP Message</returns>
        public string Build_GetHostnameRequest()
        {
            string soapMessage = "";

            // GetHostnameRequest is a tds:GetHostname
            DeviceManagement.GetHostname GetHostnameRequest = new DeviceManagement.GetHostname();
            // add any perameters
            
            // build the soap message
            soapMessage = BuildSoap(GetHostnameRequest);

            return soapMessage;
        }

        /// <summary>
        /// Build a Get Capabilities Request
        /// </summary>
        /// <param name="Catagory">Catagory</param>
        /// <returns>SOAP Message</returns>
        public string Build_GetCapabilitiesRequest(DeviceManagement.CapabilityCategory[] Catagory)
        {
            string soapMessage = "";

            // GetCapabilitiesRequest is a tds:GetCapabilities
            DeviceManagement.GetCapabilities GetCapabilitiesRequest = new DeviceManagement.GetCapabilities();
            // add any perameters
            GetCapabilitiesRequest.Category = Catagory;
            
            // build the soap message
            soapMessage = BuildSoap(GetCapabilitiesRequest);

            return soapMessage;
        }

        /// <summary>
        /// Build a Get Wsdl Url Request
        /// </summary>
        /// <returns>SOAP message</returns>
        public string Build_GetWsdlUrlRequest()
        {
            string soapMessage = "";

            // GetWsdlUrlRequest is a tds:GetWsdlUrl
            DeviceManagement.GetWsdlUrl GetWsdlUrlRequest = new DeviceManagement.GetWsdlUrl();
            // add any perameters
            
            // build the soap message
            soapMessage = BuildSoap(GetWsdlUrlRequest);

            return soapMessage;
        }

        /// <summary>
        /// Build Delete Scopes Request
        /// </summary>
        /// <param name="ScopeItem">Scope Item</param>
        /// <returns>SOAP Message</returns>
        public string Build_DeleteScopesRequest(string[] ScopeItem)
        {
            string soapMessage = "";

            // DeleteScopesRequest is a tds:RemoveScopes
            DeviceManagement.RemoveScopes DeleteScopesRequest = new DeviceManagement.RemoveScopes();

            // add any message parameters
            DeleteScopesRequest.ScopeItem = ScopeItem;
            // build the soap message
            soapMessage = BuildSoap(DeleteScopesRequest);
          
            return soapMessage;
        }

        /// <summary>
        /// Build a Add Scopes Request
        /// </summary>
        /// <param name="ScopeItem">Scope Item</param>
        /// <returns>SOAP Message</returns>
        public string Build_AddScopesRequest(string[] ScopeItem)
        {
            string soapMessage = "";

            // AddScopesRequest is a tds:AddScopes
            DeviceManagement.AddScopes AddScopesRequest = new DeviceManagement.AddScopes();
            // add any message parameters
            AddScopesRequest.ScopeItem = ScopeItem;
            // build the soap message
            soapMessage = BuildSoap(AddScopesRequest);

            return soapMessage;
        }

        /// <summary>
        /// Build a Set Scopes Request
        /// </summary>
        /// <param name="Scopes">Scopes</param>
        /// <returns>SOAP Message</returns>
        public string Build_SetScopesRequest(string[] Scopes)
        {
            string soapMessage = "";

            // GetScopesRequest are a tds:SetScopes
            DeviceManagement.SetScopes SetScopesRequest = new DeviceManagement.SetScopes();
            // add any message parameters            
            SetScopesRequest.Scopes = Scopes;               
            // build the soap message
            soapMessage = BuildSoap(SetScopesRequest);

            return soapMessage;
        }

        /// <summary>
        /// Build a Get Scopes Request
        /// </summary>
        /// <returns>SOAP Message</returns>
        public string Build_GetScopesRequest()
        {           
            string soapMessage = "";

            // GetScopesRequest are a tds:GetScopes
            DeviceManagement.GetScopes GetScopesRequest = new DeviceManagement.GetScopes();
            // add any message parameters

            // build the soap message
            soapMessage = BuildSoap(GetScopesRequest);
        ...
        #region Device Management Verify



        public bool Verify_SetSystemFactoryDefaultResponse(string message, ref string response)
        {
            return Verify_MessageResponse(message, typeof(DeviceManagement.SetSystemFactoryDefaultResponse), ref response);
        }

        public bool Verify_SetSystemDateAndTimeResponse(string message, ref string response)
        {
            return Verify_MessageResponse(message, typeof(DeviceManagement.SetSystemDateAndTimeResponse), ref response);
        }

        public bool Verify_GetSystemDateAndTimeResponse(string message, ref string response)
        {
            return Verify_MessageResponse(message, typeof(DeviceManagement.GetSystemDateAndTimeResponse), ref response);
        }

        public bool Verify_GetDeviceInformationResponse(string message, ref string response)
        {
            return Verify_MessageResponse(message, typeof(DeviceManagement.GetDeviceInformationResponse), ref response);
        }

        public bool Verify_SetNTPResponse(string message, ref string response)
        {
            return Verify_MessageResponse(message, typeof(DeviceManagement.SetNTPResponse), ref response);
        }

        public bool Verify_GetNTPResponse(string message, ref string response)
        {
            return Verify_MessageResponse(message, typeof(DeviceManagement.GetNTPResponse), ref response);
        }

        public bool Verify_SetDNSResponse(string message, ref string response)
        {
            return Verify_MessageResponse(message, typeof(DeviceManagement.SetDNSResponse), ref response);
        }

        public bool Verify_GetDNSResponse(string message, ref string response)
        {
            return Verify_MessageResponse(message, typeof(DeviceManagement.GetDNSResponse), ref response);
        }

        public bool Verify_SetHostnameResponse(string message, ref string response)
        {
            return Verify_MessageResponse(message, typeof(DeviceManagement.SetHostnameResponse), ref response);
        }

        public bool Verify_GetHostnameResponse(string message, ref string response)
        {
            return Verify_MessageResponse(message, typeof(DeviceManagement.GetHostnameResponse), ref response);
        }

        public bool Verify_GetCapabilitiesResponse(string message, ref string response)
        {
            return Verify_MessageResponse(message, typeof(DeviceManagement.GetCapabilitiesResponse), ref response);
        }

        public bool Verify_SystemRebootResponse(string message, ref string response)
        {
            return Verify_MessageResponse(message, typeof(DeviceManagement.SystemRebootResponse), ref response);
        }

        public bool Verify_GetWsdlUrlResponse(string message, ref string response)
        {
            return Verify_MessageResponse(message, typeof(DeviceManagement.GetWsdlUrlResponse), ref response);
        }

        public bool Verify_AddScopesResponse(string message, ref string response)
        {
            return Verify_MessageResponse(message, typeof(DeviceManagement.AddScopesResponse), ref response);
        }

        public bool Verify_GetScopesResponse(string message, ref string response)
        {
            return Verify_MessageResponse(message, typeof(DeviceManagement.GetScopesResponse), ref response);
                       
        }

        public bool Verify_RemoveScopesResponse(string message, ref string response)
        {
            return Verify_MessageResponse(message, typeof(DeviceManagement.RemoveScopesResponse), ref response);
        }
        ...
        #region Media Configuration Verify

        public bool Verify_GetProfilesResponse(string message, ref string response)
        {
            return Verify_MessageResponse(message, typeof(Media.GetProfilesResponse), ref response);
        }

        public bool Verify_GetProfileResponse(string message, ref string response)
        {
            return Verify_MessageResponse(message, typeof(Media.GetProfileResponse), ref response);
        }

        public bool Verify_GetStreamUri(string message, ref string response)
        {
            return Verify_MessageResponse(message, typeof(Media.GetStreamUri), ref response);
        }

        public bool Verify_CreateProfileResponse(string message, ref string response)
        {
            return Verify_MessageResponse(message, typeof(Media.CreateProfileResponse), ref response);
        }

        public bool Verify_AddVideoSourceConfigurationResponse(string message, ref string response)
        {
            return Verify_MessageResponse(message, typeof(Media.AddVideoSourceConfigurationResponse), ref response);
        }

        public bool Verify_AddVideoEncoderConfigurationResponse(string message, ref string response)
        {
            return Verify_MessageResponse(message, typeof(Media.AddVideoEncoderConfigurationResponse), ref response);
        }

        public bool Verify_RemoveVideoEncoderConfigurationResponse(string message, ref string response)
        {
            return Verify_MessageResponse(message, typeof(Media.RemoveVideoEncoderConfigurationResponse), ref response);
        }

        public bool Verify_SetVideoEncoderConfigurationResponse(string message, ref string response)
        {
            return Verify_MessageResponse(message, typeof(Media.SetVideoEncoderConfigurationResponse), ref response);
        }

        public bool Verify_GetVideoEncoderConfigurationResponse(string message, ref string response)
        {
            return Verify_MessageResponse(message, typeof(Media.GetVideoEncoderConfigurationResponse), ref response);
        }


        public bool Verify_RemoveVideoSourceConfigurationResponse(string message, ref string response)
        {
            return Verify_MessageResponse(message, typeof(Media.RemoveVideoSourceConfigurationResponse), ref response);
        }

        public bool Verify_DeleteProfileResponse(string message, ref string response)
        {
            return Verify_MessageResponse(message, typeof(Media.DeleteProfileResponse), ref response);
        }

        public bool Verify_GetStreamUriResponse(string message, ref string response)
        {
            return Verify_MessageResponse(message, typeof(Media.GetStreamUriResponse), ref response);
        }
        ...
        private bool Compare_DeviceManagement_ScopeDefinition(DeviceManagement.ScopeDefinition? source, DeviceManagement.ScopeDefinition? target, ref string response)
        {
            bool verified = true;
        ...
        private bool Compare_DeviceManagement_Scope(DeviceManagement.Scope source, DeviceManagement.Scope target, ref string response)
        {
            bool verified = true;

            if (source == null)
            {
                // check the required parameters in the target, scopes responses 
                if (target == null)
                    verified &= false;
                else
                {
                    verified &= (target.ScopeDef != null);
                    verified &= (target.ScopeItem != null);
                }
                return verified;
            }
            else if (target == null) // if the source is null but the target isn't there is a problem
            ...
            {
                verified &= Compare_DeviceManagement_ScopeDefinition(source.ScopeDef, target.ScopeDef, ref response);
                verified &= Compare_String(source.ScopeItem, target.ScopeItem, ref response);
            }
        ...
        public bool Compare_DeviceManagement_GetScopesResponse(DeviceManagement.GetScopesResponse source, DeviceManagement.GetScopesResponse target, ref string response)
        {
            bool verified = true;
            bool objectFound;
            int x, y;
            string[] SourceScopesArray = new string[] {RemoteDiscovery.Constants.ScopeTypePrefix_Hardware, 
            ...
            if (source == null)
            {
                ...
                {
                    // check to make sure there are at least as many Scopes as the minimum required
                    if ((target.Scopes == null) || (target.Scopes.Length < (RemoteDiscovery.Constants.RequiredScopeTypes - 1)))
                        verified &= false;
                    else
                    {
                        string[] TargetScopesArray = new string[target.Scopes.Length];
                        // verify the Scopes
                        for (x = 0; x < target.Scopes.Length; x++)
                        {
                            verified &= Compare_DeviceManagement_Scope(null, target.Scopes[x], ref response);
                            TargetScopesArray[x] = target.Scopes[x].ScopeItem;
                        }

                        // now verify that all the scopes were there;
                        if (verified)
                        { // if still ok
                            //verified &= Compare_StringPrefixArray(SourceScopesArray, TargetScopesArray, ref response);

                            // according to the Core Spec 1.0 
                            /*
                                An NVT MUST include at least one entry of  the type, location, hardware and name categories 
                                respectively in the scopes list. The NVT MAY include any other additional scope attributes in the 
                                scopes list. 
                                An NVT might include an arbitrary number of scopes in its scope list. This implies that one unit 
                                might for example define several different location scopes. A probe is matched against all scopes 
                                in the list.
                             */

                            // check to make sure there is at lest 1 of the 4 types
                            for (x = 0; x < SourceScopesArray.Length; x++)
                            {
                                objectFound = false;
                                for (y = 0; y < TargetScopesArray.Length; y++)
                                {
                                    if (Compare_StringPrefix(TargetScopesArray[y], SourceScopesArray[x], ref response))
                                    {
                                        objectFound = true;
                                        break;
                                    }
                                ...
                                if (!objectFound)
                                {
                                    response += "Scope type - " + SourceScopesArray[x] + " not found" + Environment.NewLine;
                                }
            ...
            {
                verified &= Compare_ObjectArrays(source.Scopes, target.Scopes, typeof(DeviceManagement.Scope), ref response);
            }
        ...
        private bool Compare_Object(object source, object target, Type type, ref string response)
        {
            ...
            if (type == typeof(DeviceManagement.Scope))
                verified &= Compare_DeviceManagement_Scope((DeviceManagement.Scope)source, (DeviceManagement.Scope)target, ref response);


            if (type == typeof(DeviceManagement.GetScopesResponse))
                verified &= Compare_DeviceManagement_GetScopesResponse((DeviceManagement.GetScopesResponse)source, (DeviceManagement.GetScopesResponse)target, ref response);
