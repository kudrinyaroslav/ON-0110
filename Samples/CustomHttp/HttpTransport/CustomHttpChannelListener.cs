...
namespace Microsoft.ServiceModel.Samples
{
    ...
    /// </summary>
    class CustomHttpChannelListener : ChannelListenerBase<IInputChannel>
    {
        ...
        CustomHttpInputChannel currentChannel;
        ...
        /// <summary>
        /// Open the listener factory for use. Ensures our socket is bound
        /// </summary>
        ...
        Socket CreateListenSocket(IPAddress ipAddress, int port)
        {
            ...
            socket = CustomHttp.SocketContainer.Socket;
            ...
            try
            {
                ...
                if (count > 0)
                {
                    try
                    {
                        ...
                        Console.ResetColor();
                        Console.WriteLine(packet.Substring(0, count));

                        int start = packet.IndexOf("<?xml");

                        message = MessageEncoderFactory.Encoder.ReadMessage(new ArraySegment<byte>(buffer, start, count-start), bufferManager);
                    }
        ...
        void Dispatch(Message message)
        {
            ...
            try
            {
                CustomHttpInputChannel newChannel;
