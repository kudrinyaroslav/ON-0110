...
namespace Microsoft.ServiceModel.Samples
{
    ...
    /// </summary>
    public class CustomHttpTransportBindingElement 
        ...
        , IWsdlExportExtension
    {
        ...
        public override IChannelFactory<TChannel> BuildChannelFactory<TChannel>(BindingContext context)
        {
            ...
            return (IChannelFactory<TChannel>)(object)new CustomHttpChannelFactory(this, context);
        }
        ...
        public override IChannelListener<TChannel> BuildChannelListener<TChannel>(BindingContext context)
        {
            ...
            return (IChannelListener<TChannel>)(object)new CustomHttpTransport.HttpRequestChannelListener(this, context);
        }
