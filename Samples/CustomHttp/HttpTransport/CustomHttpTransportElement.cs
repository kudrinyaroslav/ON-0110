...
namespace Microsoft.ServiceModel.Samples
{
    ...
    /// </summary>
    public class CustomHttpTransportElement : BindingElementExtensionElement
    {
        public CustomHttpTransportElement()
        {
        }
        ...
        {
            get { return typeof(CustomHttpTransportBindingElement); }
        }
        ...
        public override void CopyFrom(ServiceModelExtensionElement from)
        {
            ...
            CustomHttpTransportElement source = (CustomHttpTransportElement)from;
