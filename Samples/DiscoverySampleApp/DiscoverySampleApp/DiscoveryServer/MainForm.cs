...
namespace DiscoveryServer
{
    public partial class MainForm : Form
    {
        ...
        { 
            ...
            String fullAddress = tbAdresses.Text;
            String myUri = "";
            while (fullAddress.Contains(" "))
            {
                myUri = fullAddress.Substring(fullAddress.LastIndexOf(" ")).Trim();
            ...
            foreach (String myUrl in addresses)
            {
                metadata.ListenUris.Add(new Uri(myUrl));
            }
