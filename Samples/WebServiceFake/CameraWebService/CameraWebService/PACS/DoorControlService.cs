...
namespace PACS.DoorControl
{
    ...
    public abstract partial class DoorControlService : System.Web.Services.WebService
    {
        ...
        public abstract DoorCapabilities GetDoorCapabilities(string Token);
        ...
        public abstract DoorInfo[] GetDoorInfoList([System.Xml.Serialization.XmlArrayItemAttribute("Token", IsNullable = false)] string[] TokenList);
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(Namespace = "http://www.onvif.org/v3/DoorControl/wsdl")]
    public partial class DoorInfo : DataEntity
    {
