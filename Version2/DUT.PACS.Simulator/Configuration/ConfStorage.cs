...
namespace DUT.PACS.Simulator
{
    public class ConfStorage
    {
        ...
        //Schedule Service
        private Dictionary<string, ServiceSchedule10.ScheduleState> m_ScheduleStateList;
        private Dictionary<string, ServiceSchedule10.Schedule> m_ScheduleList;
        private Dictionary<string, ServiceSchedule10.SpecialDayGroup> m_SpecialDayGroupList;
        ...
        private Dictionary<string, List<CancellationTokenSource>> m_awaitingTasks;
        ...
        public Dictionary<string, ServiceSchedule10.ScheduleState> ScheduleStateList
        {
            get
            {
                if (!m_ConfStorageInitialized)
        ...
        public Dictionary<string, ServiceSchedule10.Schedule> ScheduleList
        {
            get
            {
                if (!m_ConfStorageInitialized)
        ...
        public Dictionary<string, ServiceSchedule10.SpecialDayGroup> SpecialDayGroupList
        {
            get
            {
                if (!m_ConfStorageInitialized)
        ...
        public Dictionary<string, List<CancellationTokenSource>> AwaitingTasks
        {
            get
            {
                if (!m_ConfStorageInitialized)
        ...
        private Dictionary<string, ServiceSchedule10.Schedule> ScheduleListInitialization()
        {

            Dictionary<string, ServiceSchedule10.Schedule> res = new Dictionary<string, ServiceSchedule10.Schedule>();

            ServiceSchedule10.Schedule item;
            ...
            item.Standard = "BEGIN:VCALENDAR\r\nBEGIN:VEVENT\r\nSUMMARY:Access from 9 AM to 6 PM\r\nDTSTART:20150529T090000\r\nDTEND:20150605T180000\r\nRRULE:FREQ=DAILY\r\nUID:e5442073-666e-489f-831e-dfae71fcf4c9\r\nEND:VEVENT\r\nEND:VCALENDAR";
            item.SpecialDays = new ServiceSchedule10.SpecialDaysSchedule[] { new ServiceSchedule10.SpecialDaysSchedule(), new ServiceSchedule10.SpecialDaysSchedule() };
            item.SpecialDays[0].GroupToken = "specialdaygroup1";
            item.SpecialDays[1].GroupToken = "specialdaygroup2";

            item.SpecialDays[0].TimeRange = new ServiceSchedule10.TimePeriod[] { new ServiceSchedule10.TimePeriod(), new ServiceSchedule10.TimePeriod() };
            item.SpecialDays[0].TimeRange[0].From = System.DateTime.Now;
            item.SpecialDays[0].TimeRange[0].Until = new System.DateTime(2015, 3, 30, 12, 12, 12);
            item.SpecialDays[0].TimeRange[1].From = System.DateTime.Now;
            item.SpecialDays[0].TimeRange[1].Until = new System.DateTime(2015, 3, 30, 11, 11, 11);
            item.SpecialDays[1].TimeRange = new ServiceSchedule10.TimePeriod[] { new ServiceSchedule10.TimePeriod(), new ServiceSchedule10.TimePeriod() };
            item.SpecialDays[1].TimeRange[0].From = new System.DateTime(2015, 3, 28, 12, 12, 12);
            item.SpecialDays[1].TimeRange[0].Until = new System.DateTime(2015, 3, 29, 12, 12, 12);
            item.SpecialDays[1].TimeRange[1].From = new System.DateTime(2015, 3, 28, 11, 11, 11);
            item.SpecialDays[1].TimeRange[1].Until = new System.DateTime(2015, 3, 29, 11, 11, 11);
            res.Add(item.token, item);

            item = new ServiceSchedule10.Schedule();

            item.token = "schedule2";
            item.Description = "schedule description";
            item.Name = "schedule name";
            item.Standard = "BEGIN:VCALENDAR\r\nBEGIN:VEVENT\r\nSUMMARY:Access from 9 AM to 6 PM\r\nDTSTART:20150529T090000\r\nDTEND:20150605T180000\r\nRRULE:FREQ=DAILY\r\nUID:e5442073-666e-489f-831e-dfae71fcf4c9\r\nEND:VEVENT\r\nEND:VCALENDAR";
            item.SpecialDays = new ServiceSchedule10.SpecialDaysSchedule[] { new ServiceSchedule10.SpecialDaysSchedule(), new ServiceSchedule10.SpecialDaysSchedule() };
        ...
        private Dictionary<string, ServiceAccessRules10.AccessProfile> AccessProfileListInitialization()
        {
            ...
            item.token = "accessprofile3";
            item.Name = "Access Profile 3";
            item.Description = "Access Profile Description 3";
            item.AccessPolicy = new ServiceAccessRules10.AccessPolicy[1];
            item.AccessPolicy[0] = new ServiceAccessRules10.AccessPolicy();
            item.AccessPolicy[0].ScheduleToken = "schedule2";
            item.AccessPolicy[0].Entity = "tokenAccessPoint2";
            ...
            item.token = "accessprofile4";
            item.Name = "Access Profile 4";
            item.Description = "Access Profile Description 4";
            item.AccessPolicy = new ServiceAccessRules10.AccessPolicy[1];
            item.AccessPolicy[0] = new ServiceAccessRules10.AccessPolicy();
            item.AccessPolicy[0].ScheduleToken = "schedule2";
            item.AccessPolicy[0].Entity = "tokenAccessPoint2";
        ...
        private Dictionary<string, ServiceCredential10.Credential> CredentialListInitialization()
        {
            ...
            item.CredentialIdentifier[0].Type.Name = "pt:Card";
            ...
            item.CredentialIdentifier[1].Type.Name = "pt:PIN";
            ...
            item.CredentialIdentifier[0].ExemptedFromAuthentication = true;
            item.CredentialIdentifier[0].Type = new ServiceCredential10.CredentialIdentifierType();
            item.CredentialIdentifier[0].Type.Name = "pt:PIN";
            ...
            item.CredentialIdentifier[1].ExemptedFromAuthentication = true;
            item.CredentialIdentifier[1].Type = new ServiceCredential10.CredentialIdentifierType();
            item.CredentialIdentifier[1].Type.Name = "pt:Card";
