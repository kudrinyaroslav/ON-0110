...
{
    public class AccessControlExternalPropertyEventArgs : PropertyEventArgs
    {
        public AccessControlExternalPropertyEventArgs(PACSService service,
            DateTime utcTime,
