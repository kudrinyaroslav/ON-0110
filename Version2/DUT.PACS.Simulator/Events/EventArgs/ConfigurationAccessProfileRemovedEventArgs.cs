...
{
    public class ConfigurationAccessProfileRemovedEventArgs : NotPropertyEventArgs
    {
        public ConfigurationAccessProfileRemovedEventArgs(AccessRulesService service,
            DateTime utcTime,
