...
namespace DUT.PACS.Simulator.Events
{
    ...
    public class EventServer
    {
        ...
        public void SynchronizationPoint(int id)
        {
            ...
            if (m_eventSubsciptionList.ContainsKey(id))
            {
                ...
                //if (m_eventSubsciptionList[id].Filter == null)
                {
                    ...
                    if (m_scheduleService == null)
                    {
                        m_scheduleService = new ScheduleService();
                    }
                    m_scheduleService.SynchronizationPoint();
        ...
        #region Credential Reset Antipassback Violation

        /// <summary>
        /// Declare an event of delegate type EventHandler of TamperingEvent
        /// </summary>
        public event EventHandler<CredentiaResetAntipassbackViolationPropertyEventArgs> CredentialResetAntipassbackViolationPropertyEvent;

        public void CredentialResetAntipassbackViolationEvent(CredentialService credentialService,
            string credentialToken,
            bool apbViolation,
            bool clientUpdated)
        {
            // Copy to a temporary variable to be thread-safe.
            EventHandler<CredentiaResetAntipassbackViolationPropertyEventArgs> temp = CredentialResetAntipassbackViolationPropertyEvent;
            if (temp != null)
            {
                temp(this, new CredentiaResetAntipassbackViolationPropertyEventArgs(credentialService, DateTime.UtcNow, credentialToken) { ApbViolation = apbViolation, ClientUpdated = clientUpdated });
            }
        }
        ...
        /// <param name="src">Source of event</param>
        /// <param name="enabledPropertyEventArgs"> Event arguments </param>
        public void CredentialResetAntipassbackViolationPropertyEventHandler(object src,
            CredentiaResetAntipassbackViolationPropertyEventArgs credentialResetAntipassbackViolationPropertyEventArgs)
        {

            NotificationMessageHolderType notificationMessageHolderType =
                GenerateNotificationMessage("tns1:Credential/State/ApbViolation",
                                                credentialResetAntipassbackViolationPropertyEventArgs);

            NotifyAll(notificationMessageHolderType, PACSTopicSet.Instance.CredentialStateApbViolation);
            ...
            bool clientUpdated)
        {
            ...
            if (temp != null)
            {
                temp(this, new CredentiaEnabledPropertyEventArgs(credentialService, DateTime.UtcNow, credentialToken) { Enabled = active, Reason = reason, ClientUpdated = clientUpdated });
            }
        }
        ...
        public void CredentialEnabledPropertyEventHandler(object src,
            CredentiaEnabledPropertyEventArgs credentialEnabledPropertyEventArgs)
        {

            NotificationMessageHolderType notificationMessageHolderType =
                GenerateNotificationMessage("tns1:Credential/State/Enabled",
                                                credentialEnabledPropertyEventArgs);

            NotifyAll(notificationMessageHolderType, PACSTopicSet.Instance.CredentialStateEnabled);

            System.Diagnostics.Debug.WriteLine(credentialEnabledPropertyEventArgs.CredentialToken + ": state " + credentialEnabledPropertyEventArgs.Enabled.ToString());
        }
        ...
        #region AccessProfileRemoved

        /// <summary>
        /// Declare an event of delegate type EventHandler of ConfigurationAccessProfileChangedArgs
        /// </summary>
        public event EventHandler<ConfigurationAccessProfileRemovedEventArgs> ConfigurationAccessProfileRemovedPropertyEvent;
        ...
        /// <param name="doorToken">Door Token</param>
        /// <param name="currentState">Current Door Monitor State</param>
        public void ConfigurationAccessProfileRemovedEvent(AccessRulesService accessRulesService,
            string accessProfileToken)
        {
            // Copy to a temporary variable to be thread-safe.
            EventHandler<ConfigurationAccessProfileRemovedEventArgs> temp = ConfigurationAccessProfileRemovedPropertyEvent;
            if (temp != null)
            {
                temp(this, new ConfigurationAccessProfileRemovedEventArgs(accessRulesService, DateTime.UtcNow, accessProfileToken));
            }
        }
        ...
        /// <param name="src">Source of event</param>
        /// <param name="doorAlarmPropertyEventArgs">Event arguments</param>
        public void ConfigurationAccessProfileRemovedEventHandler(object src,
            ConfigurationAccessProfileRemovedEventArgs configurationAccessProfileRemovedEventArgs)
        {

            NotificationMessageHolderType notificationMessageHolderType =
                GenerateNotificationMessage("tns1:Configuration/AccessProfile/Removed",
                                                configurationAccessProfileRemovedEventArgs);

            NotifyAll(notificationMessageHolderType, PACSTopicSet.Instance.ConfigurationAccessProfileRemoved);

            System.Diagnostics.Debug.WriteLine(configurationAccessProfileRemovedEventArgs.AccessProfileToken + " removed");
        }
        ...
        /// <summary>
        /// Declare an event of delegate type EventHandler of ConfigurationScheduleChangedArgs
        /// </summary>
        public event EventHandler<ConfigurationScheduleChangedEventArgs> eventConfigurationScheduleChangedEvent;

        /// <summary>
        /// Catch a Schedule Changed Event
        /// </summary>
        /// <param name="scheduleService">Schedule Service object</param>
        /// <param name="scheduleToken">Schedule Token</param>
        public void ConfigurationScheduleChangedEvent(ScheduleService scheduleService,
            string scheduleToken)
        {
            // Copy to a temporary variable to be thread-safe.
            EventHandler<ConfigurationScheduleChangedEventArgs> temp = eventConfigurationScheduleChangedEvent;
            if (temp != null)
            {
                temp(this, new ConfigurationScheduleChangedEventArgs(scheduleService, DateTime.UtcNow, scheduleToken));
            }
        }

        /// <summary>
        /// Add Schedule Changed Events to corresponding subscribtions
        /// </summary>
        /// <param name="src">Source of event</param>
        /// <param name="configurationScheduleChangedEventArgs">Event arguments</param>
        public void ConfigurationScheduleChangedEventHandler(object src,
            ConfigurationScheduleChangedEventArgs configurationScheduleChangedEventArgs)
        {

            NotificationMessageHolderType notificationMessageHolderType =
                GenerateNotificationMessage("tns1:Configuration/Schedule/Changed",
                                                configurationScheduleChangedEventArgs);

            NotifyAll(notificationMessageHolderType, PACSTopicSet.Instance.ConfigurationScheduleChanged);

            System.Diagnostics.Debug.WriteLine(configurationScheduleChangedEventArgs.ScheduleToken + " Schedule changed");
        }
        ...
        /// Declare an event of delegate type EventHandler of ConfigurationScheduleChangedArgs
        /// </summary>
        public event EventHandler<ConfigurationScheduleChangedEventArgs> eventConfigurationScheduleRemovedEvent;

        /// <summary>
        /// Catch a Schedule Removed Event
        /// </summary>
        /// <param name="scheduleService">Schedule Service object</param>
        /// <param name="scheduleToken">Schedule Token</param>
        public void ConfigurationScheduleRemovedEvent(ScheduleService scheduleService,
            string scheduleToken)
        {
            // Copy to a temporary variable to be thread-safe.
            EventHandler<ConfigurationScheduleChangedEventArgs> temp = eventConfigurationScheduleRemovedEvent;
            if (temp != null)
            {
                temp(this, new ConfigurationScheduleChangedEventArgs(scheduleService, DateTime.UtcNow, scheduleToken));
            }
        ...
        /// <summary>
        /// Add Schedule Removed Events to corresponding subscribtions
        /// </summary>
        /// <param name="src">Source of event</param>
        /// <param name="configurationScheduleRemovedEventArgs">Event arguments</param>
        public void ConfigurationScheduleRemovedEventHandler(object src,
            ConfigurationScheduleChangedEventArgs configurationScheduleRemovedEventArgs)
        {

            NotificationMessageHolderType notificationMessageHolderType =
                GenerateNotificationMessage("tns1:Configuration/Schedule/Removed",
                                                configurationScheduleRemovedEventArgs);

            NotifyAll(notificationMessageHolderType, PACSTopicSet.Instance.ConfigurationScheduleRemoved);

            System.Diagnostics.Debug.WriteLine(configurationScheduleRemovedEventArgs.ScheduleToken + " Schedule removed");
        }
        ...
        #region CreateSpecialDayGroup

        /// <summary>
        /// Declare an event of delegate type EventHandler of ConfigurationSpecialDayGroupChangedArgs
        /// </summary>
        public event EventHandler<ConfigurationSpecialDayGroupChangedEventArgs> eventConfigurationSpecialDayGroupChangedEvent;

        /// <summary>
        /// Catch a SpecialDayGroup Changed Event
        /// </summary>
        /// <param name="scheduleService">Schedule Service object</param>
        /// <param name="specialDayGroupToken">SpecialDayGroup Token</param>
        public void ConfigurationSpecialDayGroupChangedEvent(ScheduleService scheduleService,
            string specialDayGroupToken)
        {
            // Copy to a temporary variable to be thread-safe.
            EventHandler<ConfigurationSpecialDayGroupChangedEventArgs> temp = eventConfigurationSpecialDayGroupChangedEvent;
            if (temp != null)
            {
                temp(this, new ConfigurationSpecialDayGroupChangedEventArgs(scheduleService, DateTime.UtcNow, specialDayGroupToken));
            }
        }

        /// <summary>
        /// Add SpecialDayGroup Changed Events to corresponding subscribtions
        /// </summary>
        /// <param name="src">Source of event</param>
        /// <param name="configurationSpecialDayGroupChangedEventArgs">Event arguments</param>
        public void ConfigurationSpecialDayGroupChangedEventHandler(object src,
            ConfigurationSpecialDayGroupChangedEventArgs configurationSpecialDayGroupChangedEventArgs)
        {

            NotificationMessageHolderType notificationMessageHolderType =
                GenerateNotificationMessage("tns1:Configuration/SpecialDays/Changed",
                                                configurationSpecialDayGroupChangedEventArgs);

            NotifyAll(notificationMessageHolderType, PACSTopicSet.Instance.ConfigurationSpecialDaysChanged);

            System.Diagnostics.Debug.WriteLine(configurationSpecialDayGroupChangedEventArgs.SpecialDayGroupToken + " SpecialDayGroup changed");
        }
        ...
        #region RemoveSpecialDayGroup

        /// <summary>
        /// Declare an event of delegate type EventHandler of ConfigurationSpecialDayGroupChangedArgs
        /// </summary>
        public event EventHandler<ConfigurationSpecialDayGroupChangedEventArgs> eventConfigurationSpecialDayGroupRemovedEvent;

        /// <summary>
        /// Catch a SpecialDayGroup Removed Event
        /// </summary>
        /// <param name="scheduleService">Schedule Service object</param>
        /// <param name="specialDayGroupToken">SpecialDayGroup Token</param>
        public void ConfigurationSpecialDayGroupRemovedEvent(ScheduleService scheduleService,
            string specialDayGroupToken)
        {
            // Copy to a temporary variable to be thread-safe.
            EventHandler<ConfigurationSpecialDayGroupChangedEventArgs> temp = eventConfigurationSpecialDayGroupRemovedEvent;
            if (temp != null)
            {
                temp(this, new ConfigurationSpecialDayGroupChangedEventArgs(scheduleService, DateTime.UtcNow, specialDayGroupToken));
            }
        ...
        /// <summary>
        /// Add SpecialDayGroup Removed Events to corresponding subscribtions
        /// </summary>
        /// <param name="src">Source of event</param>
        /// <param name="configurationSpecialDayGroupRemovedEventArgs">Event arguments</param>
        public void ConfigurationSpecialDayGroupRemovedEventHandler(object src,
            ConfigurationSpecialDayGroupChangedEventArgs configurationSpecialDayGroupRemovedEventArgs)
        {

            NotificationMessageHolderType notificationMessageHolderType =
                GenerateNotificationMessage("tns1:Configuration/SpecialDays/Removed",
                                                configurationSpecialDayGroupRemovedEventArgs);

            NotifyAll(notificationMessageHolderType, PACSTopicSet.Instance.ConfigurationSpecialDaysRemoved);

            System.Diagnostics.Debug.WriteLine(configurationSpecialDayGroupRemovedEventArgs.SpecialDayGroupToken + " SpecialDayGroup removed");
        }
        ...
        #region ScheduleStateActive

        /// <summary>
        /// Declare an event of delegate type EventHandler of DoorModePropertyEventArgs
        /// </summary>
        public event EventHandler<ScheduleStateActivePropertyEventArgs> eventScheduleStateActivePropertyEvent;
        ...
        /// <param name="doorToken">Door Token</param>
        /// <param name="currentState">Current Door Mode State</param>
        public void ScheduleStateActiveEvent(ScheduleService scheduleService, string propertyOperation, string scheduleToken, string name, bool active, bool specialDay)
        {
            // Copy to a temporary variable to be thread-safe.
            EventHandler<ScheduleStateActivePropertyEventArgs> temp = eventScheduleStateActivePropertyEvent;
            if (temp != null)
            {
                temp(this, new ScheduleStateActivePropertyEventArgs(scheduleService, DateTime.UtcNow, propertyOperation, scheduleToken, name, active, specialDay));
            }
        }
        ...
        /// <param name="src">Source of event</param>
        /// <param name="doorModePropertyEventArgs">Event arguments</param>
        public void ScheduleStateActiveEventHandler(object src, ScheduleStateActivePropertyEventArgs scheduleStateActivePropertyEventArgs)
        {

            NotificationMessageHolderType notificationMessageHolderType =
                GenerateNotificationMessage("tns1:Schedule/State/Active",
                                                scheduleStateActivePropertyEventArgs);

            NotifyAll(notificationMessageHolderType, PACSTopicSet.Instance.ScheduleStateActive);

            System.Diagnostics.Debug.WriteLine(scheduleStateActivePropertyEventArgs.ScheduleToken + " with name " + scheduleStateActivePropertyEventArgs.Name + ": state Active = " + scheduleStateActivePropertyEventArgs.Active.ToString() + " and SpecialDay = " + scheduleStateActivePropertyEventArgs.SpecialDay.ToString());
        }
