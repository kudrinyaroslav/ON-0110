...
namespace DUT.PACS.Simulator.ServiceAccessRules10
{
    ...
    public class AccessRulesService : AccessRulesBinding
    {
        ...
        public override string CreateAccessProfile(AccessProfile AccessProfile)
        {
            ...
            if (AccessProfile.AccessPolicy != null && AccessProfile.AccessPolicy.Count() > capabilities.MaxAccessPoliciesPerAccessProfile)
            {
            ...
            if (AccessProfile.AccessPolicy != null && AccessProfile.AccessPolicy.Any(C => (C.EntityType != null) && ((C.EntityType.Namespace != "http://www.onvif.org/ver10/accesscontrol/wsdl")||(C.EntityType.Name != "AccessPoint"))))
            {
            ...
            if (AccessProfile.AccessPolicy != null && AccessProfile.AccessPolicy.Any(C => !(ConfStorage.AccessPointInfoList.Keys.Contains(C.Entity))))
            {
