...
namespace DUT.PACS.Simulator.Events10
{
    ...
    public class EventService : EventBinding
    {
        ...
        public override Capabilities GetServiceCapabilities()
        {
            ...
            Capabilities capabilities = Simulator.SystemCapabilities.Instance.EventsCapabilities;

            actionHeader.actionValue = "http://www.onvif.org/ver10/events/wsdl/EventPortType/GetServiceCapabilitiesResponse";
            return capabilities;
        }
