...
namespace TestTool.Tests.Common.Discovery
{
    ...
    public class SoapBuilder
    {
        ...
        static SoapBuilder()
        {
            ...
            Stream schemaStream = Assembly.GetExecutingAssembly().GetManifestResourceStream("CameraWebService.Discovery.Schemas.xml.xsd");
            XmlSchema schemaXml = XmlSchema.Read(schemaStream, null);
            schemaStream.Close();
            schemaStream = Assembly.GetExecutingAssembly().GetManifestResourceStream("CameraWebService.Discovery.Schemas.soap-envelope.xsd");
