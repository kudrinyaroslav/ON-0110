...
namespace DUT.CameraWebService.Door11
{
    ...
    public class DoorServiceTest
    {
        ...
        private const string ServiceName = "Door11";
        ...
        private const int GetDoorInfoListByTokenList = 12;
        private const int GetDoorInfo = 13;
        ...
        internal StepType GetDoorInfoTest(out DoorInfo target, out SoapException ex, out int Timeout, string Token)
        {
            StepType res = StepType.None;
            Timeout = 0;
            ex = null;
            ...
            string tmpCommandName = "GetDoorInfo";
            int tmpCommandNumber = GetDoorInfo;
        ...
        internal StepType GetDoorInfoListTest(out DoorInfo[] target, out SoapException ex, out int Timeout, int Limit, bool LimitSpecified, int Offset, bool OffsetSpecified)
        {
            StepType res = StepType.None;
            Timeout = 0;
            ex = null;
        ...
        internal StepType GetDoorInfoListByTokenListTest(out DoorInfo[] target, out SoapException ex, out int Timeout, string[] TokenList)
        {
            StepType res = StepType.None;
            Timeout = 0;
            ex = null;
            ...
            string tmpCommandName = "GetDoorInfoListByTokenList";
            int tmpCommandNumber = GetDoorInfoListByTokenList;
