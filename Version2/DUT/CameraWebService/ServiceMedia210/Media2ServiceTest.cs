...
{
    public class Media2ServiceTest : Base.BaseServiceTest
    {
        ...
        private const int GetAudioOutputConfigurations = 15;
        private const int GetAudioDecoderConfigurations = 16;
        private const int GetAudioSourceConfigurations = 17;
        private const int RemoveConfiguration = 18;
        private const int SetVideoSourceConfiguration = 19;
        private const int SetVideoEncoderConfiguration =20;
        private const int SetAudioSourceConfiguration = 21;
        private const int GetVideoSourceConfigurationOptions = 22;
        private const int SetOSD = 23;
        private const int GetStreamUri = 24;
        private const int GetSnapshotUri = 25;
        private const int StartMulticastStreaming = 26;
        private const int StopMulticastStreaming = 27;
        private const int SetSynchronizationPoint = 28;
        private const int GetAnalyticsConfigurations = 29;
        private const int GetMetadataConfigurations = 30;
        private const int GetAudioSourceConfigurationOptions = 31;
        private const int GetMetadataConfigurationOptions = 32;
        private const int GetAudioOutputConfigurationOptions = 33;
        private const int GetAudioDecoderConfigurationOptions = 34;
        private const int GetVideoSourceModes = 35;
        private const int GetVideoEncoderInstances = 36;
        private const int SetVideoSourceMode = 37;
        private const int SetAudioOutputConfiguration = 38;
        private const int SetAudioDecoderConfiguration = 39;
        private const int SetMetadataConfiguration = 40;
        ...
        /// Constructor
        /// </summary>
        public Media2ServiceTest(TestCommon testCommon)
            : base(testCommon)
        {
