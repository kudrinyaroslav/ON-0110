namespace DUT.PACS.Simulator.Events
{
    ...
    public class PACSTopicSet : TopicSet
    {
        ...
        private Topic _configurationCredentialState;
        public Topic ConfigurationCredentialState
        {
            get { return _configurationCredentialState; }
        }

        private Topic _configurationCredentialStateChanged;
        public Topic ConfigurationCredentialStateChanged
        {
            get { return _configurationCredentialStateChanged; }
        }
        ...
        static void Initialize()
        {
            ...
            credentialStateApbViolation.MessageDescription.IsProperty = true;
            ...
            Topic configurationCredentialState = new Topic(PacsTopic.CREDENTIALSTATE, null, null, false);
            _instance._configurationCredentialState = configurationCredentialState;

            //Configuration/CredentialState/Changed [topic]
            Topic configurationCredentialStateChanged = new Topic(PacsTopic.CHANGED, null, null, true);
            _instance._configurationCredentialStateChanged = configurationCredentialStateChanged;
            configurationCredentialStateChanged.MessageDescription.IsProperty = false;
            configurationCredentialStateChanged.MessageDescription.SourceItems.Add(credentialToken);
            ...
            _instance._configurationAccessProfileRemoved = configurationCredentialRemoved;
            ...
            configuration.Add(configurationCredentialState);
            ...
            configurationCredentialState.Add(configurationCredentialStateChanged);
