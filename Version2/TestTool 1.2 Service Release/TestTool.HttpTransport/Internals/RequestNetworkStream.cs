...
namespace TestTool.HttpTransport
{
    ...
    class RequestNetworkStream
    {
        ...
        {
            System.Diagnostics.Debug.WriteLine("     EnsureOpen");
            _to = address;
            ...
            if (_socket == null || !_socket.Connected)
            {
                ...
                _socket = null;
                Connect();
                System.Diagnostics.Debug.WriteLine(string.Format("     Connected: {0}", _socket.Connected));
            }
        }
        ...
        public void Write(byte[] buffer, int offset, int count)
        {
            ...
            System.Diagnostics.Debug.WriteLine(string.Format("After write:     Connected: {0}", _socket.Connected));
        ...
        {
            System.Diagnostics.Debug.WriteLine(string.Format("Begin read:     Connected: {0}", _socket.Connected));
