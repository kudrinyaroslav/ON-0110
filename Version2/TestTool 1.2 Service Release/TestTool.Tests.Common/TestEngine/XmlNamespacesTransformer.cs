...
namespace TestTool.Tests.Common.TestEngine
{
    ...
    public class XmlNamespacesTransformer : HttpTransport.ISoapMessageMutator
    {
        ...
        {
            Stream stream = Assembly.GetExecutingAssembly().GetManifestResourceStream("TestTool.Tests.Common.TestEngine.XmlTransformation.RemoveUnusedNamespaces.xslt");
            XmlApplyTransformation(stream, xmlDocument);
        }

        void XmlMoveNamespacesToRoot(XmlDocument xmlDocument)
        {
            Stream stream = Assembly.GetExecutingAssembly().GetManifestResourceStream("TestTool.Tests.Common.TestEngine.XmlTransformation.MoveNamespacesToRoot.xslt");
            XmlApplyTransformation(stream, xmlDocument);
        }
