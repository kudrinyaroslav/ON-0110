...
using PTZ = TestTool.Proxies.Onvif;
...
namespace TestTool.Tests.TestCases.Base
{
    public class MediaTest : BaseServiceTest<Media, MediaClient>
    {
        ...
        private TestTool.Proxies.Onvif.PTZClient _ptzClient;

        private TestTool.Proxies.Onvif.PTZClient PtzClient
        {
            get
            {
                if (_ptzClient == null)
                {
                    ...
                    RunStep(() =>
                    {
                        ...
                        TestTool.Proxies.Onvif.Capabilities capabilities = device.GetCapabilities(new TestTool.Proxies.Onvif.CapabilityCategory[] { TestTool.Proxies.Onvif.CapabilityCategory.PTZ });
        ...
        protected PTZConfiguration[] GetPTZConfigurations()
        {
            ...
            RunStep(() =>
            {
                ...
                PTZ.PTZClient ptz = new PTZ.PTZClient(binding, new EndpointAddress(ptzAddress));
        ...
        protected void SetVideoEncoderConfiguration(VideoEncoderConfiguration config, bool persistence, bool multicast)
        {
