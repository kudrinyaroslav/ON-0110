...
namespace TestTool.Tests.TestCases.TestSuites
{
    ...
    partial class MediaServiceTestSuite
    {
        ...
        /*
        bool AreEqual(Proxies.Onvif.PTZConfiguration configuration1,
            Proxies.Media.PTZConfiguration configuration2, StringBuilder sb)
        {
            bool ok = true;
            bool currentOk = true;
            ...
            {
                TestTool.Proxies.Onvif.PTZSpeed speed1 = configuration1.DefaultPTZSpeed;
                TestTool.Proxies.Media.PTZSpeed speed2 = configuration2.DefaultPTZSpeed;
            ...
            {
                TestTool.Proxies.Onvif.Space2DDescription range1 = configuration1.PanTiltLimits.Range;
                TestTool.Proxies.Media.Space2DDescription range2 = configuration2.PanTiltLimits.Range;
                ...
                if (range1 != null && range2 != null)
                {
                    ...
                    TestTool.Proxies.Onvif.FloatRange r1 = range1.XRange;
                    TestTool.Proxies.Media.FloatRange r2 = range2.XRange;
            ...
            {
                TestTool.Proxies.Onvif.Space1DDescription range1 = configuration1.ZoomLimits.Range;
                TestTool.Proxies.Media.Space1DDescription range2 = configuration2.ZoomLimits.Range;
