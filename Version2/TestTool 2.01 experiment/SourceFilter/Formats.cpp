...
BYTE* GeneralFormatSupporter::CreatePrefixAndInfo(CMediaType *pmt, MediaSubsession *sub, FrameInfo **Prefix) const
{
  int Size = 0;
  switch (AsType())
  {
...
bool GeneralFormatSupporter::GetFormatVideo(CMediaType *pmt, MediaSubsession *sub, FrameInfo **Prefix) const 
{ 
...
bool GeneralFormatSupporter::GetFormat(CMediaType *pmt, MediaSubsession *sub, FrameInfo **Prefix) const 
{ 
  if (AsType() != CODEC_TYPE_VIDEO) return false;
  return GetFormatVideo(pmt, sub, Prefix);
}

bool GeneralFormatSupporter::CheckFormat(const CMediaType *pmt, MediaSubsession *sub) const 
{ 
  switch (AsType())
  {
  case CODEC_TYPE_VIDEO:
...
FrameInfo* GeneralFormatSupporter::NextChunk(MediaSubsession *sub, unsigned char* buffer, int size, FrameInfo *Prefix) const
{
...
{
public:
  bool ProbeCodec(MediaSubsession *sub) {   OutputDebugStringA(sub->codecName());
return !strcmp( sub->codecName(), "JPEG"); }
  ...
  FrameInfo* NextChunk(MediaSubsession *sub, unsigned char* buffer, int size, FrameInfo *Prefix) const
  {
    FrameInfo* Info = FrameInfo::Init(size);
    memcpy( Info->pdata, buffer, size );
...
{
  BYTE* CreatePrefixAndInfo(CMediaType *pmt, MediaSubsession *sub, FrameInfo **Prefix) const
  {
...
public:
  bool ProbeCodec(MediaSubsession *sub) { return !strncmp( sub->codecName(), "MP4V-ES", 7); }
  CodecType AsType() const { return CODEC_TYPE_VIDEO; }
...
public:
  bool ProbeCodec(MediaSubsession *sub) { return !strcmp( sub->codecName(), "H264"); }
  CodecType AsType() const { return CODEC_TYPE_VIDEO; }
...
{
public:
  bool ProbeCodec(MediaSubsession *sub) { return !strcmp( sub->codecName(), "PCMU"); }
  ...
  bool GetFormat(CMediaType *pmt, MediaSubsession *sub, FrameInfo **Prefix) const 
  { 
    //AUDIODESCRIPTION
...
{
public:
  bool ProbeCodec(MediaSubsession *sub) { return !strcmp( sub->codecName(), "PCMA"); }
  CodecType AsType() const { return CODEC_TYPE_AUDIO; }
...
{
public:
  bool ProbeCodec(MediaSubsession *sub) { return !strncmp( sub->codecName(), "G726", 4); }
  CodecType AsType() const { return CODEC_TYPE_AUDIO; }
...
{
public:
  bool ProbeCodec(MediaSubsession *sub) { return !strcmp( sub->codecName(), "MPEG4-GENERIC"); }
  CodecType AsType() const { return CODEC_TYPE_AUDIO; }
...
{
public:
  bool ProbeCodec(MediaSubsession *sub) { return !strcmp( sub->codecName(), "MP2T"); }
  CodecType AsType() const { return CODEC_TYPE_VIDEO; }
...
{
public:
  bool ProbeCodec(MediaSubsession *sub) { return !strcmp( sub->codecName(), "MPV"); }
  CodecType AsType() const { return CODEC_TYPE_VIDEO; }
...
{
public:
  bool ProbeCodec(MediaSubsession *sub) 
  { 
    return 
...
public:
  bool ProbeCodec(MediaSubsession *sub) { return !stricmp( sub->codecName(), "VND.ONVIF.METADATA"); }
