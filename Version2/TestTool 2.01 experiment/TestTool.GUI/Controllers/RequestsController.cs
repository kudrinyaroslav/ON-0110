...
namespace TestTool.GUI.Controllers
{
    class RequestsController : Controller<IRequestsView> 
    {
        ...
        public RequestsController(IRequestsView view)
            :base(view)
        {
            _serviceAddresses = new Dictionary<Service, string>();
        }
        ...
        public string RequestsRootPath
        {
            get
            {
                if (_requestsRootPath == null)
                {
                    ...
                    _requestsRootPath = Path.Combine(allUsersFolder, "ONVIF\\ONVIF Conformance Test 1.02\\Requests");
                }
        ...
        /// Service addresses
        /// </summary>
        private Dictionary<Service, string> _serviceAddresses;
