...
namespace TestTool.GUI.Controls
{
    partial class ManagementPage : Page, IManagementView
    {
        ...
        /// <summary>
        /// Enables/disables device types selection.
        /// </summary>
        /// <param name="bEnable"></param>
        public void EnableDeviceTypes(bool bEnable)
        {
            scSettings.EnableDeviceTypes(bEnable);
        }
        ...
        public DeviceType DeviceTypes
        {
            get
            {
                return scSettings.DeviceTypes;
            }
            set
            {
                scSettings.DeviceTypes = value;
        ...
        {
            get { return scSettings.Services; }
        }
        ...
        {
            scSettings.SelectFeatures(services, features);
        }
        ...
        void scSettings_DeviceTypesChanged(object sender, EventArgs e)
        {
            rbConformanceMode.Enabled = (scSettings.DeviceTypes != DeviceType.None);
        }
    }
