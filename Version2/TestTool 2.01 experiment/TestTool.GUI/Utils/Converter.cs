...
namespace TestTool.GUI.Utils
{
    ...
    static class Converter
    {
        ...
        /// <summary>
        /// Creates service requirements string.
        /// </summary>
        /// <param name="testInfo"></param>
        /// <returns></returns>
        public static string GetServicesRequirement(this TestInfo testInfo)
        {
            ...
            {
                str.Append(bFirst
                               ? string.Format("{0}", service.ToString())
                               : string.Format(", {0}", service.ToString()));

                bFirst = false;
            }

            return string.Format("Service(s): {0}", str.ToString()); 
        }
    }
}
