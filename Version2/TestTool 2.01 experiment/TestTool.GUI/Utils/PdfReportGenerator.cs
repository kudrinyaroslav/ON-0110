...
namespace TestTool.GUI.Utils
{
    ...
    class PdfReportGenerator
    {
        ...
        private void BuildCoverPage()
        {
            ...
            p0.Add(Environment.NewLine);
            p0.Add(String.Format("{0}", _log.Application.CoreSpecifications[_log.CoreSpecification]));
        ...
        private void BuildIndex()
        {
            ...
            foreach (TestInfo info in _log.Tests.OrderBy(T => T.Order))
            {
        ...
        private void AddTestGroupInfo()
        {
            ...
            foreach (TestInfo info in _log.Tests.OrderBy(TI => TI.Order))
            {
                ...
                Paragraph sectionText = new Paragraph(testDescription);
