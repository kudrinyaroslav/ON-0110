...
//#endif
    class DeviceManagementSecurityTestSuite : DeviceManagementTest
    {
            ...
            () =>
                {
                    if (needToRestore)
                    {
                        ...
                        catch (Exception ex)
                        {
                            ...
                            Assert(
                                _operator.GetOkCancelAnswer("Failed to restore current user programmatically. Please, restore this account and click OK"), 
        ...
        [Test(Name = "SECURITY COMMAND SETUSER ERROR CASE",
            Order = "06.04.08",
            Path = PATH,
            Version = 1.02,
            Services = new Service[] { Service.Device },
