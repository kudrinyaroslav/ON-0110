            ...
            RunTest(() =>
                         {
                             ...
                             // Device returns any SOAP fault - PASS
                             if (faultReceived)
                             {
                                 return;
                             }
                             ...
                             // 5. Validate that the mandatory TopicExpressionDialects are supported by the Device
                             ...
                             // 6. Validate that the mandatory MessageContentFilterDialects is supported by the Device
                             ...
                             // 7. Verify that the Device returns a valid topic namepace
