...
namespace TestTool.GUI.Controls
{
    ...
    partial class SettingsControl : Page
    {
        ...
        //private int _lastValidRelayOutputDelayBistable;
        private int _lastValidRelayOutputDelayMonostable;

        //private void tbRelayOutputDelayTimeBistable_Validating(object sender, CancelEventArgs e)
        //{
        //    int time = 0;
        //    bool bOk = int.TryParse(tbRelayOutputsDelayBistable.Text, out time);
        //    if (bOk)
        //    {
        //        bOk = time > 0;
        //    }
        //    if (!bOk)
        //    {
        //        tbRelayOutputsDelayBistable.Text = _lastValidRelayOutputDelayBistable.ToString();
        //    }
        //    else
        //    {
        //        _lastValidRelayOutputDelayBistable = time;
        //    }
        //}
