...
namespace TestTool.GUI.Utils
{
    ...
    class ManagementServiceProvider : BaseServiceProvider<DeviceClient, Device>
    {
        ...
        public void GetDeviceInformationEx()
        {
            ...
            //            try
            //            {
            //                Security = HttpTransport.ChannelControllers.Security.None;
            //                GetDeviceInformationInternal();
            //            }
            //            catch (HttpTransport.Exceptions.AccessDeniedException exc)
            //            {
            //                Security = HttpTransport.ChannelControllers.Security.Digest;
            //                GetDeviceInformationInternal();
            //            }
            ...
            //                {
            //                    Security = HttpTransport.ChannelControllers.Security.WS;
            //                    GetDeviceInformationInternal();
            //                }
            //                else
            //                {
        ...
        {
            RunInBackground(new Action(() => { Client.GetServices(true); }));
        }
