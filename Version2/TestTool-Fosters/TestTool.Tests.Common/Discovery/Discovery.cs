...
//        private const string SCOPE_MATCH_BY_URL = "http://schemas.xmlsoap.org/ws/2005/04/discovery/rfc2396"; 
        ...
        {
            Probe(true, null, null, WS_DISCOVER_TIMEOUT, types, null/*DiscoveryUtils.GetManadatoryScopes()*/);
        }
        ...
        {
            Probe(false, address, null, WS_DISCOVER_TIMEOUT, types, null/*DiscoveryUtils.GetManadatoryScopes()*/);
        }
        ...
        {
            Probe(multicast, address, deviceId, WS_DISCOVER_TIMEOUT, types, null/*DiscoveryUtils.GetManadatoryScopes()*/);
        }
