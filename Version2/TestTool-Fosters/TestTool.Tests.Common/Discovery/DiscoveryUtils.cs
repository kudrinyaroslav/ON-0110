...
namespace TestTool.Tests.Common.Discovery
{
    public class DiscoveryUtils
    {
        ...
        public static bool CheckDeviceMatchType(SoapMessage<WSD.ProbeMatchesType> message, int matchNumber, out string reason)
        {
            return CheckDeviceType(message.Raw, 
                ...
                message.Object.ProbeMatch[matchNumber].Scopes, out reason);
        }

        public static bool CheckDeviceMatchType(SoapMessage<WSD.ProbeMatchesType> message, int matchNumber)
        {
            string reason;
            return CheckDeviceMatchType(message, matchNumber, out reason);
        }
        ...
        public static bool CheckDeviceHelloType(SoapMessage<WSD.HelloType> message, out string reason)
        {
            return CheckDeviceType(message.Raw, "/s:Envelope/s:Body/wsd:Hello/wsd:Types", 
                message.Object.Scopes, out reason);
        }
                ...
                for (int i = 0; i < message.Object.ProbeMatch.Length; i++)
                {
                    ...
                    if ((match.XAddrs != null) 
                        && (types == null 
                            ...
                            ? CheckDeviceMatchType(message, i) 
