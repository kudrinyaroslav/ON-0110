...
namespace TestTool.Proxies.Onvif
{
    ...
    public interface DoorControlPort
    {
        ...
        // CODEGEN: Контракт генерации сообщений с операцией GetDoorInfoList не является ни RPC, ни упакованным документом.
        ...
        // CODEGEN: Контракт генерации сообщений с операцией AccessDoor не является ни RPC, ни упакованным документом.
