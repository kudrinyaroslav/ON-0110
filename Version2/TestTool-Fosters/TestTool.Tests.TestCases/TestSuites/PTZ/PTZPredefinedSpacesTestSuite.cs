...
namespace TestTool.Tests.TestCases.TestSuites
{
    ...
    public class PTZPredefinedSpacesTestSuite : Base.PTZTest
    {
        ...
        [Test(Name = "GENERIC PAN/TILT POSITION SPACE",
            ...
            RequiredFeatures = new Feature[] { Feature.PTZService, Feature.PTZAbsolutePanTilt },
        ...
        [Test(Name = "GENERIC ZOOM POSITION SPACE",
            ...
            Version = 1.02,
            RequirementLevel = RequirementLevel.Must,
            RequiredFeatures = new Feature[] { Feature.PTZService, Feature.PTZAbsoluteZoom },
            FunctionalityUnderTest = new Functionality[]{Functionality.PtzAbsoluteMove})]
        ...
        [Test(Name = "GENERIC PAN/TILT TRANSLATION SPACE",
            ...
            Version = 1.02,
            RequirementLevel = RequirementLevel.Must,
            RequiredFeatures = new Feature[] { Feature.PTZService, Feature.PTZRelativePanTilt },
        ...
        [Test(Name = "GENERIC ZOOM TRANSLATION SPACE",
            ...
            Version = 1.02,
            RequirementLevel = RequirementLevel.Must,
            RequiredFeatures = new Feature[] { Feature.PTZService, Feature.PTZRelativeZoom },
            FunctionalityUnderTest = new Functionality[] { Functionality.PtzRelativeMove })]
        ...
        [Test(Name = "GENERIC PAN/TILT VELOCITY SPACE",
            ...
            Version = 1.02,
            RequirementLevel = RequirementLevel.Must,
            RequiredFeatures = new Feature[] { Feature.PTZService, Feature.PTZContinuousPanTilt },
        ...
        [Test(Name = "GENERIC ZOOM VELOCITY SPACE",
            ...
            Version = 1.02,
            RequirementLevel = RequirementLevel.Must,
            RequiredFeatures = new Feature[] { Feature.PTZService, Feature.PTZContinuousZoom },
            FunctionalityUnderTest = new Functionality[] { Functionality.PtzContinuousMove })]
        ...
        [Test(Name = "GENERIC PAN/TILT SPEED SPACE",
             ...
             Version = 1.02,
             RequirementLevel = RequirementLevel.Must,
             RequiredFeatures = new Feature[] { Feature.PTZService, Feature.PTZSpeedPanTilt, Feature.PTZAbsoluteOrRelativePanTilt })]
        ...
        [Test(Name = "GENERIC ZOOM SPEED SPACE",
            ...
            Version = 1.02,
            RequirementLevel = RequirementLevel.Must,
            RequiredFeatures = new Feature[] { Feature.PTZService, Feature.PTZSpeedZoom, Feature.PTZAbsoluteOrRelativeZoom})]
