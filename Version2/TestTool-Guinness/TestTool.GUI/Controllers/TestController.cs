...
namespace TestTool.GUI.Controllers
{
    ...
    class TestController : BaseTestController<ITestView>
    {
        ...
        public List<TestInfo> LoadTests()
        {
            ...
            {
                View.ProfilesView.DisplayProfiles(_onvifProfiles.OrderBy(P => P.Name));
            }
        ...
        void DisplayFunctionalitySupport(List<TestInfo> tests)
        {
            if (View.ProfilesView != null)
            {
                ...
                ProfilesSupportInfo info = ProfilesSupportInfo.LoadPreliminary(_onvifProfiles, _testInfos, tests,
                                                                               features);
                ...
                View.ProfilesView.DisplayFailedByFeaturesFunctionality(info.MandatoryFunctionalityWithoutFeatures);
                View.ProfilesView.DisplaySkippedByFeaturesFunctionality(info.OptionalFunctionalityUnderSkippedTests);
        ...
        public override void UpdateContext()
        {
            ...
            if (View.TestTreeView != null)
            {
                List<TestInfo> selectedTests = View.TestTreeView.SelectedTests;
