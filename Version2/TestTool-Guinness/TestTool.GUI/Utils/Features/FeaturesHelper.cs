...
namespace TestTool.GUI.Utils
{
    ...
    static class FeaturesHelper
    {
        ...
        public static List<string> SelectedFeatures(TestLogFull log)
        {
            ...
            if (log.Features.Contains(Feature.Audio))
            {
            ...
            features.AddIfSelected(log, Feature.AudioOutput);
            features.AddIfSelected(log, Feature.AudioOutputG711);
            features.AddIfSelected(log, Feature.AudioOutputG726);
            features.AddIfSelected(log, Feature.AudioOutputAAC);

            // add only if top-level feature is selected
            if (log.Features.Contains(Feature.PTZService))
            {
                //
                ...
                features.AddIfSelected(log, Feature.PTZContinuousPanTilt,
                                       "Continous move - Pan/Tilt speed configuration");
                features.AddIfSelected(log, Feature.PTZContinuousZoom, "Continous move - Zoom speed configuration");
            ...
            features.AddIfSelected(log, Feature.ImagingService);
            features.AddIfSelected(log, Feature.DeviceIoService);
