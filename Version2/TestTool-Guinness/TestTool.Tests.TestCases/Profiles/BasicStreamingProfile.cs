...
namespace TestTool.Tests.TestCases.Profiles
{
    ...
    {
        public const string STREAMING_PROFILE_SCOPE = "onvif://www.onvif.org/Profile/Streaming";
            ...
            if (_profileFunctionalities == null)
            {
                ...
                _profileFunctionalities.AddRange(
                    new FunctionalityItem[]
                        {
                            // Media Streaming
                            new FunctionalityItem(){Functionality = Functionality.GetStreamUri, Path = GetProfileFeaturesPath(MEDIASTREAMING), Features = new Feature[]{Feature.MediaService}},
                            new FunctionalityItem(){Functionality = Functionality.MediaSetSynchronizationPoint, Path = GetProfileFeaturesPath(MEDIASTREAMING), Features = new Feature[]{Feature.MediaService, Feature.H264OrMPEG4}},
                            new FunctionalityItem(){Functionality = Functionality.MediaStreamingRtsp, Path = GetProfileFeaturesPath(MEDIASTREAMING), Features = new Feature[]{Feature.MediaService}},
                            new FunctionalityItem(){Functionality = Functionality.MediaStreamingRtspJpegHeaderExtension, Path = GetProfileFeaturesPath(MEDIASTREAMING), Features = new Feature[]{Feature.MediaService}},
                            ...
                            // Audio Streaming
                            new FunctionalityItem(){Functionality = Functionality.GetAudioSources, Path = GetProfileFeaturesPath(AUDIOSTREAMING), Features = new Feature[]{Feature.MediaService}},
                            new FunctionalityItem(){Functionality = Functionality.GetAudioSourceConfiguration, Path = GetProfileFeaturesPath(AUDIOSTREAMING), Features = new Feature[]{Feature.MediaService}},
                            new FunctionalityItem(){Functionality = Functionality.GetAudioSourceConfigurations, Path = GetProfileFeaturesPath(AUDIOSTREAMING), Features = new Feature[]{Feature.MediaService}},
                            new FunctionalityItem(){Functionality = Functionality.AddAudioSourceConfiguration, Path = GetProfileFeaturesPath(AUDIOSTREAMING), Features = new Feature[]{Feature.MediaService}},
                            new FunctionalityItem(){Functionality = Functionality.RemoveAudioSourceConfiguration, Path = GetProfileFeaturesPath(AUDIOSTREAMING), Features = new Feature[]{Feature.MediaService}},
                            new FunctionalityItem(){Functionality = Functionality.SetAudioSourceConfiguration, Path = GetProfileFeaturesPath(AUDIOSTREAMING), Features = new Feature[]{Feature.MediaService}},
                            new FunctionalityItem(){Functionality = Functionality.GetCompatibleAudioSourceConfigurations, Path = GetProfileFeaturesPath(AUDIOSTREAMING), Features = new Feature[]{Feature.MediaService}},
                            new FunctionalityItem(){Functionality = Functionality.GetAudioSourceConfigurationOptions, Path = GetProfileFeaturesPath(AUDIOSTREAMING), Features = new Feature[]{Feature.MediaService}},
                            new FunctionalityItem(){Functionality = Functionality.GetAudioEncoderConfiguration, Path = GetProfileFeaturesPath(AUDIOSTREAMING), Features = new Feature[]{Feature.MediaService}},
                            new FunctionalityItem(){Functionality = Functionality.GetAudioEncoderConfigurations, Path = GetProfileFeaturesPath(AUDIOSTREAMING), Features = new Feature[]{Feature.MediaService}},
                            new FunctionalityItem(){Functionality = Functionality.AddAudioEncoderConfiguration, Path = GetProfileFeaturesPath(AUDIOSTREAMING), Features = new Feature[]{Feature.MediaService}},
                            new FunctionalityItem(){Functionality = Functionality.RemoveAudioEncoderConfiguration, Path = GetProfileFeaturesPath(AUDIOSTREAMING), Features = new Feature[]{Feature.MediaService}},
                            new FunctionalityItem(){Functionality = Functionality.SetAudioEncoderConfiguration, Path = GetProfileFeaturesPath(AUDIOSTREAMING), Features = new Feature[]{Feature.MediaService}},
                            new FunctionalityItem(){Functionality = Functionality.GetCompatibleAudioEncoderConfigurations, Path = GetProfileFeaturesPath(AUDIOSTREAMING), Features = new Feature[]{Feature.MediaService}},
                            new FunctionalityItem(){Functionality = Functionality.GetAudioEncoderConfigurationOptions, Path = GetProfileFeaturesPath(AUDIOSTREAMING), Features = new Feature[]{Feature.MediaService}},
                            // Multicast
                            new FunctionalityItem(){Functionality = Functionality.StartMulticastStreaming, Path = GetProfileFeaturesPath(MEDIASTREAMINGMULTICAST), Features = new Feature[]{Feature.MediaService}},
                            new FunctionalityItem(){Functionality = Functionality.StopMulticastStreaming, Path = GetProfileFeaturesPath(MEDIASTREAMINGMULTICAST), Features = new Feature[]{Feature.MediaService}},
                            // Relay outputs
                            new FunctionalityItem(){Functionality = Functionality.GetRelayOutputs, Path = GetProfileFeaturesPath(RELAYOUTPUTS), Features = new Feature[]{Feature.RelayOutputs}},
                            new FunctionalityItem(){Functionality = Functionality.SetRelayOutputSettings, Path = GetProfileFeaturesPath(RELAYOUTPUTS), Features = new Feature[]{Feature.RelayOutputs}},
                            new FunctionalityItem(){Functionality = Functionality.SetRelayOutputState, Path = GetProfileFeaturesPath(RELAYOUTPUTS), Features = new Feature[]{Feature.RelayOutputs}},
                            // NTP
                            ...
                            // Dynamic DNS
                            new FunctionalityItem(){Functionality = Functionality.GetDynamicDNS, Path = GetProfileFeaturesPath(DYNAMICIP)},
                            new FunctionalityItem(){Functionality = Functionality.SetDynamicDNS, Path = GetProfileFeaturesPath(DYNAMICIP)},
                            // Zero Configuration
                            ...
                            new FunctionalityItem(){Functionality = Functionality.GetIPAddressFilter, Path = GetProfileFeaturesPath(IPFILTERING)},
                            new FunctionalityItem(){Functionality = Functionality.SetIPAddressFilter, Path = GetProfileFeaturesPath(IPFILTERING)},
                            new FunctionalityItem(){Functionality = Functionality.AddIPAddressFilter, Path = GetProfileFeaturesPath(IPFILTERING)},
                            new FunctionalityItem(){Functionality = Functionality.RemoveIPAddressFilter, Path = GetProfileFeaturesPath(IPFILTERING)},
                ...
                new FunctionalityItem[]
                    {
                        ...
                        new FunctionalityItem(){Functionality = Functionality.SetSystemFactoryDefaults, Path = GetCoreFullPath(SYSTEM)},
                        ...
                        // Event handling
                        new FunctionalityItem(){Functionality = Functionality.Notify, Path = GetCoreFullPath(EVENT)},
                        new FunctionalityItem(){Functionality = Functionality.Subscribe, Path = GetCoreFullPath(EVENT)},
        ...
        public ProfileStatus Check(out string reason, IEnumerable<Feature> features, IEnumerable<string> scopes)
        {
            ...
            else
            {
                ...
                checkNextMandatory(Feature.MediaService, "Media Streaming");
