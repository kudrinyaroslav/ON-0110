...
namespace TestTool.Tests.TestCases
{
    public partial class SearchRecordingsTestSuite
    {
        ...
        protected void ValidateFullRecordingsList(GetRecordingsResponseItem[] fullList)
        {
            ...
            Assert(tokensOk, logger.ToStringTrimNewLine(),
                   "Validate recordings list got from GetRecordings");
        }


        void ValidateSearchResult(IEnumerable<RecordingInformation> recordings)
        {
        ...
        void ValidateRecordingsListNotEmpty(IEnumerable<RecordingInformation> recordings)
        {
        ...
        protected void ValidateFoundRecordingsInformation(IEnumerable<RecordingInformation> recordings)
        {
            ...
            Assert(ok, logger.ToStringTrimNewLine(),
                   "Check that Recording information and Tracks information are consitent");
        ...
        GetRecordingsResponseItem[] GetAllRecordings()
        {
            ...
            ValidateFullRecordingsList(recordings);
            return recordings;
        }
