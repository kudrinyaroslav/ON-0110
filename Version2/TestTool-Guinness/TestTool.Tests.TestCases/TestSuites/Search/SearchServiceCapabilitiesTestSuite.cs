...
namespace TestTool.Tests.TestCases.TestSuites
{
    ...
    class SearchServiceCapabilitiesTestSuite : DeviceManagementTest
    {
        ...
        [Test(Name = "GET SERVICES – RECORDING SEARCH SERVICE",
            ...
            Path = /*PATH*/ "Device Management\\Capabilities",
            Version = 2.1,
        ...
        public void SearchServicesTest()
        {
            RunTest(() =>
            {
                ...
                Service service = services.FindService(Definitions.Onvif.OnvifService.SEARCH);
                Assert(service != null, "Search service not found",
                       "Check that DUT returned Search service address");
                // ToDo : version check?
                ...
                service = services.FindService(Definitions.Onvif.OnvifService.SEARCH);
                Assert(service != null, "Search service not found",
                       "Check that DUT returned Search service address");
        ...
        [Test(Name = "GET SERVICES AND GET RECORDING SEARCH SERVICE CAPABILITIES CONSISTANCY",
            Order = "01.01.02",
            Id = "1-1-2",
            Category = Category.SEARCH,
            Path = PATH,
