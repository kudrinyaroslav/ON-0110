...
namespace TestTool.Tests.Definitions.Features
{
    ...
    public class FeaturesSet
    {
        ...
        public static FeaturesSet CreateFeaturesSet()
        {
            ...
            FeatureNode metadataRecording = new FeatureNode() { Name = "MetadataRecording", Feature = Feature.MetadataRecording };
            featuresSet.Nodes.Add(metadataRecording);
        ...
        static FeatureNode CreateAdvancedSecurityNode()
        {
            ...
            var keyStoreNode = new FeatureNode() { Name = "Keystore features support", Feature = Feature.KeyStoreFeaturesSupport };
            ...
            var tlsServerNode = new FeatureNode() { Name = "TLS features support", Feature = Feature.TLSFeaturesSupport };
