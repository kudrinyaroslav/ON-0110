...
namespace TestTool.Tests.Engine.Base.Definitions
{
    ...
    public class TestLaunchParam : BaseTestParam
    {
        ...
        private FeatureDefinitionMode _featureDefinitionMode;
        public FeatureDefinitionMode FeatureDefinitionMode
        {
            get { return _featureDefinitionMode; }
            set { _featureDefinitionMode = value; }
        }
