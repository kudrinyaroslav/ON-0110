...
namespace TestTool.Tests.Engine
{
    ...
    public class TestDispatcher
    {
        ...
        /// </summary>
        public event BaseTest.NetworkSettingsChanged NetworkSettingsChangedEvent;
...
*/ 
        ...
        void SubscribeToTestEvents(BaseTest test)
        {
            ...
            test.NetworkSettingsChangedEvent += new BaseTest.NetworkSettingsChanged(test_OnNetworkSettingsChanged);
        }
