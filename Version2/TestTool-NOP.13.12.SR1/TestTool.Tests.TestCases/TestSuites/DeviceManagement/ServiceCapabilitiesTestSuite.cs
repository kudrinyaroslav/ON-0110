...
{
    [TestClass]
    class ServiceCapabilitiesTestSuite : DeviceManagementTest
    {
        ...
        [Test(Name = "GET SERVICES – EVENT SERVICE",
             ...
             Version = 2.1,
             RequirementLevel = RequirementLevel.Must,
             RequiredFeatures = new Feature[] { Feature.GetServices, Feature.EventsService },
             FunctionalityUnderTest = new Functionality[] { Functionality.GetServices })]
        ...
        void CompareCapabilities(Proxies.Event.Capabilities serviceSapabilities, 
            Proxies.Event.Capabilities capabilities)
        {
            BeginStep(COMPARECAPABILITIESSTEP);
            ...
            local = TestUtils.BatchCheckBooleanAllowMissing(serviceSapabilities, capabilities, GETSERVICES, GETSERVICECAPABILITIES, batch, "", dump);
            equal = equal && local;
