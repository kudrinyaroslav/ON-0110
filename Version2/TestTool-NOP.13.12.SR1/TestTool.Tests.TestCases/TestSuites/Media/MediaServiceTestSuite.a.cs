...
namespace TestTool.Tests.TestCases.TestSuites
{
    ...
    partial class MediaServiceTestSuite : Base.MediaTest
    {
        ...
        private const string PATH_3_4 = "Media Configuration\\Audio Configuration\\Audio Output Configuration";
        ...
        [Test(Name = "PROFILES CONSISTENCY",
            ...
            FunctionalityUnderTest = new Functionality[]{Functionality.GetProfiles, Functionality.GetProfile})]
        ...
        [Test(Name = "AUDIO SOURCE CONFIGURATIONS AND PROFILES CONSISTENCY",
            ...
            FunctionalityUnderTest = new Functionality[] { Functionality.GetProfiles, Functionality.GetAudioSourceConfigurations })]
        ...
        [Test(Name = "AUDIO SOURCE CONFIGURATIONS AND AUDIO SOURCE CONFIGURATION OPTIONS CONSISTENCY",
            ...
            RequirementLevel = RequirementLevel.Must,
            RequiredFeatures = new Feature[] { Feature.MediaService, Feature.Audio },
            FunctionalityUnderTest = new Functionality[] { Functionality.GetAudioSourceConfigurations, Functionality.GetAudioSourceConfigurationOptions})]
        ...
        [Test(Name = "PROFILES AND AUDIO SOURCE CONFIGURATION OPTIONS CONSISTENCY",
            ...
            RequirementLevel = RequirementLevel.Must,
            RequiredFeatures = new Feature[] { Feature.MediaService, Feature.Audio },
            FunctionalityUnderTest = new Functionality[] { Functionality.GetProfiles, Functionality.GetAudioSourceConfigurationOptions })]
        ...
        [Test(Name = "AUDIO SOURCE CONFIGURATIONS AND AUDIO SOURCES CONSISTENCY",
            ...
            RequirementLevel = RequirementLevel.Must,
            RequiredFeatures = new Feature[] { Feature.MediaService, Feature.Audio },
            FunctionalityUnderTest = new Functionality[] { Functionality.GetAudioSourceConfigurations, Functionality.GetAudioSources})]
        ...
        [Test(Name = "AUDIO ENCODER CONFIGURATIONS AND PROFILES CONSISTENCY",
            ...
            RequirementLevel = RequirementLevel.Must,
            RequiredFeatures = new Feature[] { Feature.MediaService, Feature.Audio },
            FunctionalityUnderTest = new Functionality[] { Functionality.GetProfiles, Functionality.GetAudioEncoderConfigurations })]
        ...
        [Test(Name = "AUDIO ENCODER CONFIGURATIONS AND AUDIO ENCODER CONFIGURATION CONSISTENCY",
            ...
            RequirementLevel = RequirementLevel.Must,
            RequiredFeatures = new Feature[] { Feature.MediaService, Feature.Audio },
            FunctionalityUnderTest = new Functionality[] { Functionality.GetAudioEncoderConfiguration, Functionality.GetAudioEncoderConfigurations })]
        ...
        [Test(Name = "AUDIO ENCODER CONFIGURATIONS AND AUDIO ENCODER CONFIGURATION OPTIONS CONSISTENCY",
            ...
            RequirementLevel = RequirementLevel.Must,
            RequiredFeatures = new Feature[] { Feature.MediaService, Feature.Audio },
            FunctionalityUnderTest = new Functionality[] { Functionality.GetAudioEncoderConfigurationOptions, Functionality.GetAudioEncoderConfigurations })]
        ...
        [Test(Name = "PROFILES AND AUDIO ENCODER CONFIGURATION OPTIONS CONSISTENCY",
            ...
            RequirementLevel = RequirementLevel.Must,
            RequiredFeatures = new Feature[] { Feature.MediaService, Feature.Audio },
            FunctionalityUnderTest = new Functionality[] { Functionality.GetProfiles, Functionality.GetAudioEncoderConfiguration })]
        ...
        [Test(Name = "VIDEO SOURCE CONFIGURATIONS AND PROFILES CONSISTENCY",
            ...
            Version = 2.0,
            RequirementLevel = RequirementLevel.Must,
            FunctionalityUnderTest =  new Functionality[]{Functionality.GetProfiles, Functionality.GetVideoSourceConfigurations},
            RequiredFeatures = new Feature[] { Feature.MediaService })]
        ...
        [Test(Name = "VIDEO SOURCE CONFIGURATIONS AND VIDEO SOURCE CONFIGURATION CONSISTENCY",
            ...
            RequirementLevel = RequirementLevel.Must,
            RequiredFeatures = new Feature[] { Feature.MediaService },
            FunctionalityUnderTest = new Functionality[] { Functionality.GetVideoSourceConfigurations, Functionality.GetVideoSourceConfiguration})]
        ...
        [Test(Name = "VIDEO SOURCE CONFIGURATIONS AND VIDEO SOURCE CONFIGURATION OPTIONS CONSISTENCY",
            ...
            RequirementLevel = RequirementLevel.Must,
            RequiredFeatures = new Feature[] { Feature.MediaService },
            FunctionalityUnderTest = new Functionality[]{Functionality.GetVideoSourceConfigurations, Functionality.GetVideoSourceConfigurationOptions})]
        ...
        [Test(Name = "PROFILES AND VIDEO SOURCE CONFIGURATION OPTIONS CONSISTENCY",
            ...
            RequirementLevel = RequirementLevel.Must,
            RequiredFeatures = new Feature[] { Feature.MediaService },
            FunctionalityUnderTest = new Functionality[] { Functionality.GetProfiles, Functionality.GetVideoSourceConfigurationOptions})]
        ...
        [Test(Name = "VIDEO SOURCE CONFIGURATIONS AND VIDEO SOURCES CONSISTENCY",
            ...
            Version = 2.0,
            RequirementLevel = RequirementLevel.Must,
            FunctionalityUnderTest = new Functionality[]{Functionality.GetVideoSourceConfigurations, Functionality.GetVideoSources},
            RequiredFeatures = new Feature[] { Feature.MediaService })]
        ...
        [Test(Name = "VIDEO ENCODER CONFIGURATIONS AND VIDEO ENCODER CONFIGURATION CONSISTENCY",
            ...
            RequirementLevel = RequirementLevel.Must,
            RequiredFeatures = new Feature[] { Feature.MediaService },
            FunctionalityUnderTest = new Functionality[] { Functionality.GetVideoEncoderConfigurations, Functionality.GetVideoEncoderConfiguration })]
        ...
        [Test(Name = "VIDEO ENCODER CONFIGURATIONS AND VIDEO ENCODER CONFIGURATION OPTIONS CONSISTENCY",
            ...
            RequirementLevel = RequirementLevel.Must,
            RequiredFeatures = new Feature[] { Feature.MediaService },
            FunctionalityUnderTest = new Functionality[] { Functionality.GetVideoEncoderConfigurations, Functionality.GetVideoEncoderConfigurationOptions})]
        ...
        [Test(Name = "PROFILES AND VIDEO ENCODER CONFIGURATION OPTIONS CONSISTENCY",
            ...
            RequirementLevel = RequirementLevel.Must,
            RequiredFeatures = new Feature[] { Feature.MediaService },
            FunctionalityUnderTest = new Functionality[] { Functionality.GetProfiles, Functionality.GetVideoEncoderConfigurationOptions })]
        ...
        [Test(Name = "PTZ CONFIGURATIONS AND PROFILES CONSISTENCY",
            ...
            FunctionalityUnderTest = new Functionality[] { Functionality.GetProfiles, Functionality.GetPtzConfigurations })]
