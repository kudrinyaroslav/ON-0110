...
namespace TestTool.Tests.TestCases.TestSuites
{
    ...
    class RtpTestSuite : RTSSTestSuite
    {
        ...
        public void NvtStartAndStopMulticastStreamingJpegIPv4()
        {
            ...
            RunTest(() =>
            {
                StartMulticastStreaming(out profile, VideoEncoding.JPEG, null, changeLog);
            },
            () =>
            {
                StopMulticastStreaming(profile);
        ...
        public void NvtStartAndStopMulticastStreamingG711IPv4()
        {
            ...
            RunTest(() =>
            {
                StartMulticastStreaming(out profile, null, AudioEncoding.G711, changeLog);
            },
            () =>
            {
                StopMulticastStreaming(profile);
        ...
        public void NvtStartAndStopMulticastStreamingJpegG711IPv4()
        {
            ...
            RunTest(() =>
            {
                StartMulticastStreaming(out profile, VideoEncoding.JPEG, AudioEncoding.G711, changeLog);
            },
            () =>
            {
                StopMulticastStreaming(profile);
        ...
        public void StartAndStopMulticastStreamingG711IPv4AudioOnly()
        {
            ...
            RunTest(() =>
            {
                ...
                // streaming
                AudioMulticastStreamingSetup(ref profile, audioOptions, AudioEncoding.G711,
        ...
        public void StartAndStopMulticastStreamingG726IPv4AudioOnly()
        {
            ...
            RunTest(() =>
            {
                ...
                // streaming
                AudioMulticastStreamingSetup(ref profile, audioOptions, AudioEncoding.G726,
                    TransportProtocol.UDP, StreamType.RTPMulticast, IPType.IPv4, out multicastStarted, changeLog);
            },
            () =>
            {
        ...
        public void StartAndStopMulticastStreamingAACIPv4AudioOnly()
        {
            ...
            RunTest(() =>
            {
                ...
                // streaming
                AudioMulticastStreamingSetup(ref profile, audioOptions, AudioEncoding.AAC,
                    TransportProtocol.UDP, StreamType.RTPMulticast, IPType.IPv4, out multicastStarted, changeLog);
            },
            () =>
            {
