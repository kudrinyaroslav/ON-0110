...
namespace TestTool.Tests.TestCases.TestSuites
{
    ...
    class RtspVideoTestSuite : RtspTestSuite
    {
        ...
        public void NvtMediaStreamingJpegRtpRtspTcp()
        {
            ...
            RunTest(() =>
            {
                MediaUri streamUri = GetJpegMediaUri(StreamType.RTPUnicast, TransportProtocol.RTSP, changeLog);
                ValidateVideoSequence();
            },
            () =>
            {
        ...
        public void NvtMediaStreamingMpeg4RtpUnicastUdp()
        {
            ...
            RunTest(() =>
            {
                MediaUri streamUri = GetMpeg4MediaUri(StreamType.RTPUnicast, TransportProtocol.UDP, changeLog);
                ValidateVideoSequence();
            },
            () =>
            {
        ...
        public void NvtMediaStreamingMpeg4RtpUnicastRtspHttpTcp()
        {
            ...
            RunTest(() =>
            {
                MediaUri streamUri = GetMpeg4MediaUri(StreamType.RTPUnicast, TransportProtocol.HTTP, changeLog);
                ValidateVideoSequence();
            },
            () =>
            {
        ...
        public void NvtMediaStreamingMpeg4RtpRtspTcp()
        {
            ...
            RunTest(() =>
            {
                MediaUri streamUri = GetMpeg4MediaUri(StreamType.RTPUnicast, TransportProtocol.RTSP, changeLog);
                ValidateVideoSequence();
            },
            () =>
            {
       ...
       public void NvtMediaStreamingH264RtpUnicastRtspHttpTcp()
       {
           ...
           RunTest(() =>
           {
               MediaUri streamUri = GetH264MediaUri(StreamType.RTPUnicast, TransportProtocol.HTTP, changeLog);
               ValidateVideoSequence();
           },
            () =>
            {
       ...
       public void NvtMediaStreamingH264RtpRtspTcp()
       {
           ...
           RunTest(() =>
           {
               MediaUri streamUri = GetH264MediaUri(StreamType.RTPUnicast, TransportProtocol.RTSP, changeLog);
               ValidateVideoSequence();
           },
            () =>
            {
       ...
       [ Test( Name = "MEDIA STREAMING – JPEG (RTP-Multicast/UDP, IPv4)",
        ...
        public void NvtMediaStreamingJpegRtpMulticastUdpIPv4()
        {
            ...
            () =>
            {
                MediaUri streamUri = GetJpegMediaUri(StreamType.RTPMulticast, TransportProtocol.UDP, IPType.IPv4, changeLog);
                ValidateVideoSequence();
            },
            () =>
            {
        ...
        public void NvtMediaStreamingMpeg4RtpMulticastUdpIPv4()
        {
            ...
            () =>
            {
                MediaUri streamUri = GetMpeg4MediaUri(StreamType.RTPMulticast, TransportProtocol.UDP, IPType.IPv4, changeLog);
                ValidateVideoSequence();
            },
            () =>
            {
        ...
        public void NvtMediaStreamingH264RtpMulticastUdpIPv4()
        {
            ...
            () =>
            {
                MediaUri streamUri = GetH264MediaUri(StreamType.RTPMulticast, TransportProtocol.UDP, IPType.IPv4, changeLog);
                ValidateVideoSequence();
            },
            () =>
            {
        ...
        public void NvtMediaStreamingJpegRtpMulticastUdpIPv6()
        {
            ...
            () =>
            {
                MediaUri streamUri = GetJpegMediaUri(StreamType.RTPMulticast, TransportProtocol.UDP, IPType.IPv6, changeLog);
                ValidateVideoSequence();
            },
            () =>
            {
        ...
        public void NvtMediaStreamingMpeg4RtpMulticastUdpIPv6()
        {
            ...
            () =>
            {
                MediaUri streamUri = GetMpeg4MediaUri(StreamType.RTPMulticast, TransportProtocol.UDP, IPType.IPv6, changeLog);
                ValidateVideoSequence();
            },
            () =>
            {
        ...
        public void NvtMediaStreamingH264RtpMulticastUdpIPv6()
        {
            ...
            () =>
            {
                MediaUri streamUri = GetH264MediaUri(StreamType.RTPMulticast, TransportProtocol.UDP, IPType.IPv6, changeLog);
                ValidateVideoSequence();
            },
            () =>
            {
       ...
       public void NvtNotificationStreaming()
       {
           ...
           RunTest(() =>
           {
               profile = CreateProfile("Test", null);
