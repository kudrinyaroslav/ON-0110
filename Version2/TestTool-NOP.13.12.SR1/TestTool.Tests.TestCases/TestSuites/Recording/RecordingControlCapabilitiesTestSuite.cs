...
namespace TestTool.Tests.TestCases.TestSuites.Recording
{
    ...
    public class RecordingControlCapabilitiesTestSuite : RecordingTest
    {
        ...
        void CompareCapabilities(RecordingServiceCapabilities serviceCapabilities, RecordingServiceCapabilities capabilities)
        {
            ...
            // 
            local = CheckFloatField(serviceCapabilities, capabilities, C => C.MaxRate,
                                              C => C.MaxRateSpecified, "MaxRate", "GetServices", "GetServiceCapabilities", dump);

            equal = equal && local;

            local = CheckFloatField(serviceCapabilities, capabilities, C => C.MaxRecordings,
                                              C => C.MaxRecordingsSpecified, "MaxRecordings", "GetServices", "GetServiceCapabilities", dump);

            equal = equal && local;

            local = CheckFloatField(serviceCapabilities, capabilities, C => C.MaxTotalRate,
                                              C => C.MaxTotalRateSpecified, "MaxTotalRate", "GetServices", "GetServiceCapabilities", dump);
