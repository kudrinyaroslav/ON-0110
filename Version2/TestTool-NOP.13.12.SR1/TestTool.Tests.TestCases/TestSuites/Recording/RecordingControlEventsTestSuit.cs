...
namespace TestTool.Tests.TestCases.TestSuites.Recording
{
    ...
    partial class RecordingControlEventsTestSuite : PacsEventsTestSuite
    {
        ...
        //public void createTrackEvenCreateTrackTest()
        //{
        //    SubscriptionHandler subscriptionHandler = null;
        ...
        //    bool recordingCreated = false;
        //    RecordingConfiguration initialConfig = null;
        //    string createdTrackToken = null;

        //    var deletedTracks = new List<KeyValuePair<string, TrackConfiguration>>();
        ...
        //                List<KeyValuePair<string, TrackConfiguration>> selectedTracks;
        //                selectedRecordingToken = SelectOrCreateRecordingAnnex6(out initialConfig, out selectedTracks, out recordingCreated);
        ...
        //                bool keepTryingFlag = true;
        //                var lastAttemptedTrackToDelete = selectedTracks.GetEnumerator();
        //                while (keepTryingFlag)
        //                {
        //                    try
        //                    {
        //                        createdTrackToken = CreateTrack(selectedRecordingToken, config);
        //                        break;
        //                    }
        ...
        //                        Assert(e.IsValidOnvifFault("Receiver/Action/MaxTracks"),
        //                               string.Format("Unexpected SOAP Fault with Code = '{0}' received. Only fault with Code = 'Action/MaxTracks' is valid.", e.Code),
        //                               "Check that valid fault is received");

        //                        keepTryingFlag = false;
        //                        while (lastAttemptedTrackToDelete.MoveNext())
        //                        {
        //                            try
        //                            {
        //                                DeleteTrack(selectedRecordingToken, lastAttemptedTrackToDelete.Current.Key);
        //                                deletedTracks.Add(lastAttemptedTrackToDelete.Current);
        //                                keepTryingFlag = true;
        //                                break;
        //                            }
        ...
        //                Assert(keepTryingFlag && !string.IsNullOrEmpty(createdTrackToken),
        //                       "Can't create new track even after attempt to delete every existing track",
        //                       "Check that new track is successfully created");

        //                //Pull until notifications for all recording jobs are received
        //                var createdTrackSet = new[] { new KeyValuePair<string, string>(selectedRecordingToken, createdTrackToken) };
        ...
        //                var notificationDescription = new RecordingControlNotificationDescription();
        //                notificationDescription.addItemDescription(new NotificationItemDescription("Source/SimpleItem", "RecordingToken", "RecordingReference", OnvifMessage.ONVIF) 
        //                                                                                              { AllowedValues = new List<string>() { selectedRecordingToken } });

        //                notificationDescription.addItemDescription(new NotificationItemDescription("Source/SimpleItem", "TrackToken", "TrackReference", OnvifMessage.ONVIF) 
        //                                                                                              { AllowedValues = createdTrackSet.Select(e => e.Value).ToList() });
        ...
        //                if (recordingCreated)
        //                {
        //                    DeleteRecording(selectedRecordingToken);
        //                }
        //                else
        //                {
        //                    if (!string.IsNullOrEmpty(createdTrackToken))
        //                        DeleteTrack(selectedRecordingToken, createdTrackToken);

        //                    foreach (var track in deletedTracks)
        //                    {
        //                        CreateTrack(track.Key, track.Value);
        //                    }

        //                    if (null != initialConfig)
        //                        SetRecordingConfiguration(selectedRecordingToken, initialConfig);
        //                }
        //            });
        //}
        ...
        //public void deleteTrackEvenDeleteTrackTest()
        //{
        //    SubscriptionHandler subscriptionHandler = null;
        ...
        //                var deletedTrackToken = "";
        //                if (!string.IsNullOrEmpty(createdTrackToken))
        //                    try
        //                    {
        //                        DeleteTrack(selectedRecordingToken, createdTrackToken);
        //                        deletedTrackToken = createdTrackToken;
        //                        createdTrackToken = null;
        //                    }
        //                    catch (FaultException e)
        //                    {
        //                        StepPassed();
        ...
        //                        try
        //                        {
        //                            DeleteTrack(selectedRecordingToken, track.Key);
        //                            deletedTrackToken = track.Key;
        ...
        //                Assert(!string.IsNullOrEmpty(deletedTrackToken),
        //                       "None one of tracks has been deleted",
        //                       "Check that one of tracks has been deleted");

        //                //Pull until notifications for all recording jobs are received
        //                var trackSet = new[] { new KeyValuePair<string, string>(selectedRecordingToken, deletedTrackToken) };
        ...
        //                var notificationDescription = new RecordingControlNotificationDescription();
        //                notificationDescription.addItemDescription(new NotificationItemDescription("Source/SimpleItem", "RecordingToken", "RecordingReference", OnvifMessage.ONVIF) { AllowedValues = new List<string>() { selectedRecordingToken } });
