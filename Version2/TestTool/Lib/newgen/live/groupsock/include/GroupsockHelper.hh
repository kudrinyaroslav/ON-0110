...
int setupDatagramSocket(UsageEnvironment& env, Port port, int af = AF_INET);
int setupStreamSocket(UsageEnvironment& env,
		      Port port, Boolean makeNonBlocking = True, int af = AF_INET);
...
Boolean socketJoinGroup(UsageEnvironment& env, int socket,
			 NetAddress const& groupAddress, u_int32_t nicIndex = 0);
Boolean socketLeaveGroup(UsageEnvironment& env, int socket,
			 NetAddress const& groupAddress, u_int32_t nicIndex = 0);
