...
{
    class DeviceListViewItemSorter: IComparer
    {
        [DefaultValue(0)]
        public int sortByColumn { get; protected set; }

        public bool ascendingOrder { get; set; }
        public char sortingArrow { get { return ascendingOrder ? upArrow : downArrow; } }
        public string sortingImageKey{ get { return ascendingOrder ? "Up" : "Down"; } }
        
        public DeviceListViewItemSorter(int column, bool useDescendingOrder)
        {
            sortByColumn = column;
            ascendingOrder = !useDescendingOrder;
        }

        public int Compare(object x, object y)
        {
            var x1 = x as ListViewItem;
            var y1 = y as ListViewItem;
            return (ascendingOrder ? 1 : -1)*string.Compare(x1.SubItems[sortByColumn].Text, y1.SubItems[sortByColumn].Text);
        }
    ...
    partial class DiscoveryPage
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.hdrHardware = new ColumnHeader();
            this.hdrManufacturer = new ColumnHeader();
            ...
            this.panelDiscovery = new System.Windows.Forms.Panel();
            this.panelScopes = new System.Windows.Forms.Panel();
            this.tbSearchScopes = new System.Windows.Forms.TextBox();
            this.lblSearchScopes = new System.Windows.Forms.Label();
            this.chkEnableSearchOptions = new System.Windows.Forms.CheckBox();
            ...
            this.lblNIC.Location = new System.Drawing.Point(4, 20);
            ...
            // tbPassword
            // 
            this.tbPassword.Anchor =
                ((System.Windows.Forms.AnchorStyles)
                 (((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Left)
                   | System.Windows.Forms.AnchorStyles.Right)));
            this.tbPassword.Location = new System.Drawing.Point(143, 149);
            ...
            // lblFirmwareVersion
            // 
            this.lblFirmwareVersion.Anchor =
                ((System.Windows.Forms.AnchorStyles)
            ...
            this.tbBrand.TabIndex = 17;
            this.tbBrand.Text = "<Press Check to get information>";
            // 
            // btnCheckService
            // 
            this.btnCheckService.Anchor =
                ((System.Windows.Forms.AnchorStyles)
            ...
            // lblMetadataVersion
            // 
            this.lblMetadataVersion.Anchor =
                ((System.Windows.Forms.AnchorStyles)
                 ((System.Windows.Forms.AnchorStyles.Bottom | System.Windows.Forms.AnchorStyles.Left)));
            ...
            this.tbMetadataVersion.TabIndex = 16;
            // 
            // cmbServiceAddress
            // 
            this.cmbServiceAddress.Anchor =
                ((System.Windows.Forms.AnchorStyles)
                 (((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Left)
                   | System.Windows.Forms.AnchorStyles.Right)));
            ...
            this.cmbServiceAddress.SelectedIndexChanged +=
                new System.EventHandler(this.cmbServiceAddress_SelectedIndexChanged);
            this.cmbServiceAddress.TextChanged += new System.EventHandler(this.cmbServiceAddress_TextChanged);
            ...
            this.lblScopes.Location = new System.Drawing.Point(6, 177);
            ...
            // tbScopes
            // 
            this.tbScopes.Anchor =
                ((System.Windows.Forms.AnchorStyles)
                 ((((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Bottom)
                    | System.Windows.Forms.AnchorStyles.Left)
                   | System.Windows.Forms.AnchorStyles.Right)));
            this.tbScopes.Location = new System.Drawing.Point(143, 177);
            ...
            this.tbScopes.Size = new System.Drawing.Size(318, 132);
            ...
            this.lvDevices.Columns.AddRange(new System.Windows.Forms.ColumnHeader[]
                {
                    ...
                    this.hdrUUID,
                    this.hdrHardware,
                    this.hdrManufacturer
                });
            this.lvDevices.FullRowSelect = true;
            this.lvDevices.GridLines = true;
            this.lvDevices.Location = new System.Drawing.Point(3, 35);
            this.lvDevices.MultiSelect = false;
            this.lvDevices.Name = "lvDevices";
            this.lvDevices.Size = new System.Drawing.Size(335, 258);
            ...
            if (null == this.lvDevices.SmallImageList)
                this.lvDevices.SmallImageList = new ImageList();
            this.lvDevices.SmallImageList.Images.Add("Up", Properties.Resources.Up);
            this.lvDevices.SmallImageList.Images.Add("Down", Properties.Resources.Down);
            this.lvDevices.SmallImageList.Images.Add("Empty", Properties.Resources.Empty);
            this.lvDevices.SmallImageList.ImageSize = new Size(Properties.Resources.Empty.Width, Properties.Resources.Empty.Height);

            this.lvDevices.ColumnClick +=
                (sender, args) =>
                    {
                        if (null == lvDevices.ListViewItemSorter)
                        {
                            var sorter = new DeviceListViewItemSorter(args.Column, false);
                            lvDevices.ListViewItemSorter = sorter;
                            lvDevices.Columns[args.Column].ImageKey = sorter.sortingImageKey;
                        }
                        else
                        {
                            var currentSorter = lvDevices.ListViewItemSorter as DeviceListViewItemSorter;
                            var currentColumn = lvDevices.Columns[currentSorter.sortByColumn];

                            if (args.Column == currentSorter.sortByColumn)
                            {
                                currentSorter.ascendingOrder = !currentSorter.ascendingOrder;
                            }
                            else
                            {
                                var sorter = new DeviceListViewItemSorter(args.Column, false);
                                lvDevices.ListViewItemSorter = sorter;
                                currentColumn.ImageKey = "Empty";
                            }
                            lvDevices.Columns[args.Column].ImageKey = ((DeviceListViewItemSorter)lvDevices.ListViewItemSorter).sortingImageKey;
                        }
            ...
            this.hdrHardware.Text = "Hardware";
            this.hdrHardware.Width = 120;

            this.hdrManufacturer.Text = "Manufacturer";
            this.hdrManufacturer.Width = 120;
            // 
            // btnDiscover
            // 
            this.btnDiscover.Anchor = ((System.Windows.Forms.AnchorStyles)(((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Left)
                        | System.Windows.Forms.AnchorStyles.Right)));
            this.btnDiscover.Location = new System.Drawing.Point(3, 6);
            this.btnDiscover.Name = "btnDiscover";
            this.btnDiscover.Size = new System.Drawing.Size(335, 23);
            ...
            this.panelSearch.Controls.Add(this.chkEnableSearchOptions);
            this.panelSearch.Location = new System.Drawing.Point(4, 71);
            this.panelSearch.Margin = new System.Windows.Forms.Padding(0);
            this.panelSearch.Name = "panelSearch";
            this.panelSearch.Size = new System.Drawing.Size(344, 404);
            ...
            this.panelDiscovery.Dock = System.Windows.Forms.DockStyle.Fill;
            this.panelDiscovery.Location = new System.Drawing.Point(0, 105);
            this.panelDiscovery.Name = "panelDiscovery";
            this.panelDiscovery.Size = new System.Drawing.Size(344, 299);
            ...
            this.panelScopes.Dock = System.Windows.Forms.DockStyle.Top;
            this.panelScopes.Location = new System.Drawing.Point(0, 17);
            this.panelScopes.Name = "panelScopes";
            this.panelScopes.Size = new System.Drawing.Size(344, 88);
            this.panelScopes.TabIndex = 11;
            // 
            // tbSearchScopes
            // 
            this.tbSearchScopes.Anchor = ((System.Windows.Forms.AnchorStyles)((((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Bottom)
                        | System.Windows.Forms.AnchorStyles.Left)
                        | System.Windows.Forms.AnchorStyles.Right)));
            this.tbSearchScopes.Location = new System.Drawing.Point(3, 21);
            this.tbSearchScopes.Multiline = true;
            this.tbSearchScopes.Name = "tbSearchScopes";
            this.tbSearchScopes.ScrollBars = System.Windows.Forms.ScrollBars.Both;
            this.tbSearchScopes.Size = new System.Drawing.Size(335, 60);
            ...
            this.lblSearchScopes.Location = new System.Drawing.Point(0, 8);
            this.lblSearchScopes.Name = "lblSearchScopes";
            this.lblSearchScopes.Size = new System.Drawing.Size(46, 13);
            this.lblSearchScopes.TabIndex = 0;
            this.lblSearchScopes.Text = "Scopes:";
            // 
            // chkEnableSearchOptions
            // 
            this.chkEnableSearchOptions.AutoSize = true;
            this.chkEnableSearchOptions.Checked = true;
            this.chkEnableSearchOptions.CheckState = System.Windows.Forms.CheckState.Checked;
            this.chkEnableSearchOptions.Dock = System.Windows.Forms.DockStyle.Top;
            this.chkEnableSearchOptions.Location = new System.Drawing.Point(0, 0);
            this.chkEnableSearchOptions.Name = "chkEnableSearchOptions";
            this.chkEnableSearchOptions.Padding = new System.Windows.Forms.Padding(6, 0, 0, 0);
            this.chkEnableSearchOptions.Size = new System.Drawing.Size(344, 17);
            this.chkEnableSearchOptions.TabIndex = 10;
            this.chkEnableSearchOptions.Text = "Enable search options";
            this.chkEnableSearchOptions.UseVisualStyleBackColor = true;
            this.chkEnableSearchOptions.CheckedChanged += new System.EventHandler(this.chkShowSearchOptions_CheckedChanged);
            // 
            // DiscoveryPage
            // 
        ...
        private System.Windows.Forms.ColumnHeader hdrHardware;
        private System.Windows.Forms.ColumnHeader hdrManufacturer;
        ...
        private System.Windows.Forms.CheckBox chkEnableSearchOptions;
        private System.Windows.Forms.Panel panelScopes;
        private System.Windows.Forms.TextBox tbSearchScopes;
        private System.Windows.Forms.Label lblSearchScopes;
