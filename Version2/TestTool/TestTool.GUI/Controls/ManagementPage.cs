...
namespace TestTool.GUI.Controls
{
    partial class ManagementPage : Page, IManagementView
    {
        ...
        void ApplyProfile(Profile profile)
        {
            ...
            scSettings.FirmwareFilePath = profile.FirmwareFilePath;
            scSettings.CredentialIdentifierValueFirst = profile.CredentialIdentifierValueFirst;
            scSettings.CredentialIdentifierValueSecond = profile.CredentialIdentifierValueSecond;
            scSettings.CredentialIdentifierValueThird = profile.CredentialIdentifierValueThird;
        ...
        void scSettings_GetSupportedCredentialIdentifierFormatTypes(object sender, EventArgs e)
        {
            try
            {
                _controller.QueryCredentialIdentifierFormatTypes((sender as ComboBox).Text);
            }
            catch (System.Exception ex)
            {
                ShowError(ex.Message);
