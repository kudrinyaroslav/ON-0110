...
namespace TestTool.GUI.Views
{
    ...
    interface ITestSettingsView: IView
    {
        ...
        CredentialIdentifierValue CredentialIdentifierValueFirst { get; set; }        
        CredentialIdentifierValue CredentialIdentifierValueSecond { get; set; }
        CredentialIdentifierValue CredentialIdentifierValueThird { get; set; }
        ...
        void SetSupportedCredentialIdentifierTypes(IEnumerable<string> types);
        void SetSupportedCredentialIdentifierFormatTypes(string typeName, IEnumerable<string> types);
    }
