    ...
    class HttpHelper
    {
            ...
            ref int nonceCounter)
        {
            ...
            if (packet != null)
            {
                ...
                var digestHeader = HttpDigest.CreateDigestAuthenticationHeader(parameters,
                                                                               testingSettings,
                                                                               ref nonceBack,
                                                                               ref nonceCounter);
            ...
            int bodyOffset)
        {
            try
            {
                ...
                string message = Encoding.UTF8.GetString(formattedStream.GetBuffer(), 0, (int)formattedStream.Length);
