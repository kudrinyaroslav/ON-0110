...
namespace TestTool.HttpTransport
{
    ...
    class HttpChannelFactory : ChannelFactoryBase<IRequestChannel>
    {
        ...
        protected MessageEncoderFactory _messageEncoderFactory;
        protected HttpTransportBindingElement _bindingElement;
        ...
        {
            get { return this._bufferManager; }
        }

        public MessageEncoderFactory MessageEncoderFactory
        {
            get { return this._messageEncoderFactory; }
        }
