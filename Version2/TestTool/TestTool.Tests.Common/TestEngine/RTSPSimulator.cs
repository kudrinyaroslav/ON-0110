...
namespace TestTool.Tests.Common.TestEngine
{
    ...
    {
        //private const string DllFilePath = "RTSPSimulator.dll";
        ...
        public bool StartRTSP()
        {
            ...
            if (useCodecs != 0)
            {
                ...
                //Ensure that RTSP simulator started successfully: let him work for 2 seconds.
                if (_runResult.AsyncWaitHandle.WaitOne(2000))
                    return false;
        ...
        public void StopRTSP()
        {
            ...
            if (_runResult != null)
            {
                ...
                if (null != _runAction)
                {
                    //Check for potential thrown exception at Start().
                    //Rethrow it only once: finally-block guarantees it.
                    try
