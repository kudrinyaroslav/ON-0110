...
namespace TestTool.Tests.Definitions
{
    ...
    public static class FeaturesHelper
    {
        ...
        static void InitDisplayNames()
        {
            ...
            _displayNames.Add(Feature.HttpFirmwareUpgrade, "HTTP Firmware Upgrade");
            _displayNames.Add(Feature.HttpSupportInformation, "HTTP Support Information");
            _displayNames.Add(Feature.HttpSystemLogging, "HTTP System Logging");
            _displayNames.Add(Feature.HttpSystemBackup, "HTTP System Backup");
            _displayNames.Add(Feature.HttpSystemBackupOrHttpSystemLoggingOrHttpSupportInformation, "HTTP System Backup OR HTTP System Logging OR HTTP Support Information");
            ...
            _displayNames.Add(Feature.IrCutfilterConfiguration, "IrCutfilter Configuration");
            ...
            _displayNames.Add(Feature.AdvancedSecurity, "Advanced Security Service");
            ...
            _displayNames.Add(Feature.PassphraseManagement, "Passphrase Management");
            _displayNames.Add(Feature.PKCS8RSAKeyPairUpload, "PKCS#8 Container Upload");
            _displayNames.Add(Feature.PKCS12CertificateWithRSAPrivateKeyUpload, "PKCS#12 Container Upload");

            _displayNames.Add(Feature.CRLs, "CRLs");
            _displayNames.Add(Feature.CertificationPathValidationPolicies, "Certification path validation policies");
            _displayNames.Add(Feature.TLSWebClientAuthExtKeyUsage, "TLS WWW client auth extended key usage extension");
            _displayNames.Add(Feature.TLSClientAuthentication, "TLS client authentication");
            // Temprary commented according ticket #971
            //_displayNames.Add(Feature.FeaturesSupport802Dot1X, "802.1X features support");
            //_displayNames.Add(Feature.Configurations802Dot1X, "802.1X configurations");

            _displayNames.Add(Feature.Credential, "Credential Service");
            _displayNames.Add(Feature.CredentialValidity, "Credential Validity");
            _displayNames.Add(Feature.CredentialAccessProfileValidity, "Credential Access Profile Validity");
            _displayNames.Add(Feature.PtCard, "pt:Card");
            _displayNames.Add(Feature.PtFingerprint, "pt:Fingerprint");
            _displayNames.Add(Feature.PtIris, "pt:Iris");
            _displayNames.Add(Feature.PtPIN, "pt:PIN");
            _displayNames.Add(Feature.PtVein, "pt:Vein");
            _displayNames.Add(Feature.PtFace, "pt:Face");
            _displayNames.Add(Feature.ValiditySupportsTimeValue, "Validity Supports Time Value");
            _displayNames.Add(Feature.ResetAntipassbackViolation, "Reset Antipassback Violation");
            _displayNames.Add(Feature.MultipleSchedulesAccessPoint, "Multiple Schedules per Access Point");
            _displayNames.Add(Feature.CredentialValidityOrCredentialAccessProfileValidity, "Credential Validity OR Credential Access Profile Validity");

            _displayNames.Add(Feature.Schedule, "Schedule Service");
            _displayNames.Add(Feature.ExtendedRecurrence, "Extended Recurrence");
            _displayNames.Add(Feature.SpecialDays, "Special Days");
            _displayNames.Add(Feature.StateReporting, "State Reporting");

            _displayNames.Add(Feature.DeviceServiceSecurity, "Security");
            _displayNames.Add(Feature.MaxUsers, "Maximum Users");
            _displayNames.Add(Feature.DefaultAccessPolicy, "Default Access Policy");
            _displayNames.Add(Feature.RemoteUserHandling, "Remote User Handling");
            _displayNames.Add(Feature.MaximumUsernameLength, "Maximum Username Length");
            _displayNames.Add(Feature.MaximumPasswordLength, "Maximum Password Length");
            
            _displayNames.Add(Feature.MonitoringEvents, "Monitoring Events");
            _displayNames.Add(Feature.MonitoringProcessorUsageEvent, "Monitoring/ProcessorUsage");
            _displayNames.Add(Feature.MonitoringOperatingTimeLastResetEvent, "Monitoring/OperatingTime/LastReset");
            _displayNames.Add(Feature.MonitoringOperatingTimeLastRebootEvent, "Monitoring/OperatingTime/LastReboot");
            _displayNames.Add(Feature.MonitoringOperatingTimeLastClockSynchronizationEvent, "Monitoring/OperatingTime/LastClockSynchronization");
            _displayNames.Add(Feature.MonitoringBackupLastEvent, "Monitoring/Backup/Last");
            _displayNames.Add(Feature.DeviceHardwareFailureFanFailureEvent, "Device/HardwareFailure/FanFailure");
            _displayNames.Add(Feature.DeviceHardwareFailurePowerSupplyFailureEvent, "Device/HardwareFailure/PowerSupplyFailure");
            _displayNames.Add(Feature.DeviceHardwareFailureStorageFailureEvent, "Device/HardwareFailure/StorageFailure");
            _displayNames.Add(Feature.DeviceHardwareFailureTemperatureCriticalEvent, "Device/HardwareFailure/TemperatureCritical");

            //Access Rules
            _displayNames.Add(Feature.AccessRulesService, "Access Rules Service");
        }
