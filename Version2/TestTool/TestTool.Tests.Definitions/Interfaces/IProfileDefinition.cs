...
namespace TestTool.Tests.Definitions.Interfaces
{
    public interface IProfileDefinition
    {
        ...
        bool IsFunctionalityOptional(Functionality functionality, IEnumerable<Feature> supportedFeatures);
        /// <summary>
        /// List of mandatory scopes
        /// </summary>
        IEnumerable<String> MandatoryScopes { get; }

        IEnumerable<Feature> MandatoryDiscoveryTypes { get; }
        ...
        /// <returns></returns>
        ProfileStatus Check(out string reason, IEnumerable<Feature> features, IEnumerable<string> scopes, Dictionary<string, object> parameters);
    }
}
