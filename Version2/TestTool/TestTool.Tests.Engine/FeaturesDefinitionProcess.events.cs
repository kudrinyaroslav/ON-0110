...
namespace TestTool.Tests.Engine
{
    partial class FeaturesDefinitionProcess
    {
        ...
        private Dictionary<TopicInfo, Feature> GetMonitoringEventTopics()
        {
            return new Dictionary<TopicInfo, Feature>
                {
                    {
                        ConstructPacsTopic(new string[] {"Monitoring", "ProcessorUsage" }),
                        Feature.MonitoringProcessorUsageEvent
                    },
                    {
                        ConstructPacsTopic(new string[] {"Monitoring", "OperatingTime", "LastReset"}),
                        Feature.MonitoringOperatingTimeLastResetEvent
                    },
                    {
                        ConstructPacsTopic(new string[] {"Monitoring", "OperatingTime", "LastReboot"}),
                        Feature.MonitoringOperatingTimeLastRebootEvent
                    },
                    {
                        ConstructPacsTopic(new string[] {"Monitoring", "OperatingTime", "LastClockSynchronization"}),
                        Feature.MonitoringOperatingTimeLastClockSynchronizationEvent
                    },
                    {
                        ConstructPacsTopic(new string[] {"Monitoring", "Backup", "Last"}),
                        Feature.MonitoringBackupLastEvent
                    },
                    {
                        ConstructPacsTopic(new string[] { "Device", "HardwareFailure", "FanFailure" }),
                        Feature.DeviceHardwareFailureFanFailureEvent
                    },
                    {
                        ConstructPacsTopic(new string[] { "Device", "HardwareFailure", "PowerSupplyFailure" }),
                        Feature.DeviceHardwareFailurePowerSupplyFailureEvent
                    },
                    {
                        ConstructPacsTopic(new string[] { "Device", "HardwareFailure", "StorageFailure" }),
                        Feature.DeviceHardwareFailureStorageFailureEvent
                    },
                    {
                        ConstructPacsTopic(new string[] { "Device", "HardwareFailure", "TemperatureCritical" }),
                        Feature.DeviceHardwareFailureTemperatureCriticalEvent
                    },
                };
        }
