...
public partial class TopicExpressionType: IXmlSerializable, IXmlNamespaceResolver
{
    ...
    private Dictionary<string, string> m_Namespaces = new Dictionary<string, string>();
    ...
    public void ReadXml(XmlReader reader)
    {
        ...
        reader = XmlReader.Create(reader.ReadSubtree(), new XmlReaderSettings() { IgnoreWhitespace = true });
        ...
        var any = new List<XmlNode>();
        while (reader.Read())
        {
            if (reader.NodeType == XmlNodeType.Text)
            {
                string topic = reader.Value;
                var parts = topic.Split('\\', '/');

                foreach (var part in parts)
                {
                    var prefixTopic = part.Split(':');
                    if (2 == prefixTopic.Count() && null != initialReader.LookupNamespace(prefixTopic.First()) && !m_Namespaces.ContainsKey(prefixTopic.First()))
                    {
                        m_Namespaces.Add(prefixTopic.First(), initialReader.LookupNamespace(prefixTopic.First()));
                    }
                }
            }

            any.Add(doc.ReadNode(reader));
        }

        initialReader.ReadEndElement();

        anyField = any.ToArray();
    }

    public void WriteXml(XmlWriter writer)
    {
        foreach (var prefix in m_Namespaces)
        {
            writer.WriteAttributeString("xmlns", prefix.Key, null, prefix.Value);
        }

        foreach (var xmlNode in Any)
        {
            writer.WriteValue(xmlNode.InnerText);
        }
    }
...
public interface EventPortType
{
    ...
    [System.ServiceModel.OperationContractAttribute(Action = "http://www.onvif.org/ver10/events/wsdl/EventPortType/GetServiceCapabilitiesRequest", ReplyAction = "*")]
    [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
    [return: System.ServiceModel.MessageParameterAttribute(Name="Capabilities")]
    EventServiceCapabilities GetServiceCapabilities();
    ...
    [System.ServiceModel.OperationContractAttribute(Action="http://www.onvif.org/ver10/events/wsdl/EventPortType/CreatePullPointSubscriptionRequest", ReplyAction="http://www.onvif.org/ver10/events/wsdl/EventPortType/CreatePullPointSubscriptionResponse")]
    [System.ServiceModel.FaultContractAttribute(typeof(ResourceUnknownFaultType), Action="*", Name="ResourceUnknownFault", Namespace="http://docs.oasis-open.org/wsrf/r-2")]
    [System.ServiceModel.FaultContractAttribute(typeof(InvalidFilterFaultType), Action="*", Name="InvalidFilterFault", Namespace="http://docs.oasis-open.org/wsn/b-2")]
    [System.ServiceModel.FaultContractAttribute(typeof(TopicExpressionDialectUnknownFaultType), Action="*", Name="TopicExpressionDialectUnknownFault", Namespace="http://docs.oasis-open.org/wsn/b-2")]
    [System.ServiceModel.FaultContractAttribute(typeof(InvalidTopicExpressionFaultType), Action="*", Name="InvalidTopicExpressionFault", Namespace="http://docs.oasis-open.org/wsn/b-2")]
    [System.ServiceModel.FaultContractAttribute(typeof(TopicNotSupportedFaultType), Action="*", Name="TopicNotSupportedFault", Namespace="http://docs.oasis-open.org/wsn/b-2")]
    [System.ServiceModel.FaultContractAttribute(typeof(InvalidProducerPropertiesExpressionFaultType), Action="*", Name="InvalidProducerPropertiesExpressionFault", Namespace="http://docs.oasis-open.org/wsn/b-2")]
    [System.ServiceModel.FaultContractAttribute(typeof(InvalidMessageContentExpressionFaultType), Action="*", Name="InvalidMessageContentExpressionFault", Namespace="http://docs.oasis-open.org/wsn/b-2")]
    [System.ServiceModel.FaultContractAttribute(typeof(UnacceptableInitialTerminationTimeFaultType), Action="*", Name="UnacceptableInitialTerminationTimeFault", Namespace="http://docs.oasis-open.org/wsn/b-2")]
    [System.ServiceModel.FaultContractAttribute(typeof(UnrecognizedPolicyRequestFaultType), Action="*", Name="UnrecognizedPolicyRequestFault", Namespace="http://docs.oasis-open.org/wsn/b-2")]
    [System.ServiceModel.FaultContractAttribute(typeof(UnsupportedPolicyRequestFaultType), Action="*", Name="UnsupportedPolicyRequestFault", Namespace="http://docs.oasis-open.org/wsn/b-2")]
    [System.ServiceModel.FaultContractAttribute(typeof(NotifyMessageNotSupportedFaultType), Action="*", Name="NotifyMessageNotSupportedFault", Namespace="http://docs.oasis-open.org/wsn/b-2")]
    [System.ServiceModel.FaultContractAttribute(typeof(SubscribeCreationFailedFaultType), Action="*", Name="SubscribeCreationFailedFault", Namespace="http://docs.oasis-open.org/wsn/b-2")]
    [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
...
[System.ComponentModel.DesignerCategoryAttribute("code")]
[System.Xml.Serialization.XmlTypeAttribute(Namespace="http://www.onvif.org/ver10/events/wsdl")]
public partial class EventServiceCapabilities
{
...
public partial class TopicSetType : ExtensibleDocumented, IXmlSerializable, IXmlNamespaceResolver
{
    ...
    public void ReadXml(XmlReader reader)
    {
        //This structure contains XML node per each event inside TopicSet node. Each node describes the structure of event.
        //The fields of event are  described by nodes SimpleItemDescription that contains 2 attributes: Name and Type.
        //Attribute Type is a qualified type name, so namespace resolving is needed.
        //But as far as Type isn't default field its value isn't analyzed for namespace prefix using. So some prefix declarations are lost. 
        //And validation of this event's description is impossible to perform.
        //Solution: manually scan for all attributes and store values of used prefixes.

        var rootNamespace = "http://docs.oasis-open.org/wsn/t-1";
        ...
        var rootElementNamespace = reader.NamespaceURI;

        if (rootNamespace != rootElementNamespace || "TopicSet" != rootElementName)
            throw new System.Xml.XmlException(string.Format("There is no root element with name '{0}' from namespace '{1}'", rootElementName, rootNamespace));

        var doc = new XmlDocument();
        var xml = reader.ReadOuterXml();
        doc.LoadXml(xml);

        var nm = new XmlNamespaceManager(reader.NameTable);
        var prefixName = "topicSetNamespacePrefix";
        nm.AddNamespace(prefixName, rootElementNamespace);

        var nodes = doc.SelectNodes(string.Format("{0}:{1}", prefixName, rootElementName), nm);

        this.Any = nodes[0].ChildNodes.OfType<XmlElement>().ToArray();

        foreach (var e in Any)
        {
            var r = new XmlNodeReader(e);
            r.MoveToContent();
            while (r.Read())
            {
                if (XmlNodeType.Element == r.NodeType && r.HasAttributes)
                {
                    ...
                    do
                    {
                        if ("Type" == r.Name)
                        {
                            var value = r.Value.Split(new char[] { ':' });
                            if (2 == value.Count())
                            {
                                var namespaceValue1 = r.LookupNamespace(value[0]);
                                var namespaceValue2 = reader.LookupNamespace(value[0]);

                                if (!m_Namespaces.ContainsKey(value[0]))
                                {
                                    if (!string.IsNullOrEmpty(namespaceValue1))
                                        m_Namespaces.Add(value[0], namespaceValue1);
                                    else if (!string.IsNullOrEmpty(namespaceValue2))
                                        m_Namespaces.Add(value[0], namespaceValue2);
                                }

                                if (!string.IsNullOrEmpty(namespaceValue1))
                                    e.SetAttribute(string.Format("xmlns:{0}", value[0]), namespaceValue1);
                                else if (!string.IsNullOrEmpty(namespaceValue2))
                                    e.SetAttribute(string.Format("xmlns:{0}", value[0]), namespaceValue2);
                            }
                        }
...
{
    //internal class ResponseLogger : IEndpointBehavior, IClientMessageInspector
    //{
    ...
    //    {
    //        var newReplyBin = reply.CreateBufferedCopy(int.MaxValue);
    //        reply = newReplyBin.CreateMessage();

    //        var dst = new StringBuilder();
    //        var writer = XmlWriter.Create(dst);
    //        newReplyBin.CreateMessage().WriteMessage(writer);
    //        writer.Flush();

    //        lastRawResponse = dst.ToString();
    //    }

    //    public string lastRawResponse;
    //}

    //private ResponseLogger m_Logger = new ResponseLogger();

    private void InsertResponseLogger()
    {
        //this.Endpoint.Behaviors.Add(m_Logger);
    }
    
    public EventPortTypeClient()
    {
        InsertResponseLogger();
    }
    ...
    public EventServiceCapabilities GetServiceCapabilities()
    {
...
public interface PullPointSubscription
{
    ...
    [System.ServiceModel.FaultContractAttribute(typeof(PullMessagesFaultResponseType), Action="*", Name="PullMessagesFaultResponse")]
    [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
    ...
    [System.ServiceModel.OperationContractAttribute(Action="http://www.onvif.org/ver10/events/wsdl/PullPointSubscription/SetSynchronizationPointRequest", ReplyAction="http://www.onvif.org/ver10/events/wsdl/PullPointSubscription/SetSynchronizationPointResponse")]
    [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
...
public partial class SeekRequest
{
    ...
    [System.ServiceModel.MessageBodyMemberAttribute(Namespace="http://www.onvif.org/ver10/events/wsdl", Order=1)]
    // manual altering default proxy code to support optional value (bool->string)
...
/*  useless construction, and it is not supporting optional Reverse  
...
public partial class PullPointSubscriptionClient : System.ServiceModel.ClientBase<PullPointSubscription>, PullPointSubscription
{
    ...
    public void Seek(System.DateTime UtcTime, bool? Reverse, System.Xml.XmlElement[] Any)
    {
        ...
        // manual altering default proxy code to support optional value
        inValue.Reverse = Reverse.HasValue ? (Reverse.Value ? "true": "false") : null;
        inValue.Any = Any;
...
public interface NotificationProducer
{
    ...
    [System.ServiceModel.OperationContractAttribute(Action="http://docs.oasis-open.org/wsn/bw-2/NotificationProducer/GetCurrentMessageRequest", ReplyAction="*")]
    [System.ServiceModel.FaultContractAttribute(typeof(ResourceUnknownFaultType), Action="http://docs.oasis-open.org/wsn/bw-2/NotificationProducer/GetCurrentMessageRequest", Name="ResourceUnknownFault", Namespace="http://docs.oasis-open.org/wsrf/r-2")]
    [System.ServiceModel.FaultContractAttribute(typeof(TopicExpressionDialectUnknownFaultType), Action="http://docs.oasis-open.org/wsn/bw-2/NotificationProducer/GetCurrentMessageRequest", Name="TopicExpressionDialectUnknownFault", Namespace="http://docs.oasis-open.org/wsn/b-2")]
    [System.ServiceModel.FaultContractAttribute(typeof(InvalidTopicExpressionFaultType), Action="http://docs.oasis-open.org/wsn/bw-2/NotificationProducer/GetCurrentMessageRequest", Name="InvalidTopicExpressionFault", Namespace="http://docs.oasis-open.org/wsn/b-2")]
    [System.ServiceModel.FaultContractAttribute(typeof(TopicNotSupportedFaultType), Action="http://docs.oasis-open.org/wsn/bw-2/NotificationProducer/GetCurrentMessageRequest", Name="TopicNotSupportedFault", Namespace="http://docs.oasis-open.org/wsn/b-2")]
    [System.ServiceModel.FaultContractAttribute(typeof(NoCurrentMessageOnTopicFaultType), Action="http://docs.oasis-open.org/wsn/bw-2/NotificationProducer/GetCurrentMessageRequest", Name="NoCurrentMessageOnTopicFault", Namespace="http://docs.oasis-open.org/wsn/b-2")]
    [System.ServiceModel.FaultContractAttribute(typeof(MultipleTopicsSpecifiedFaultType), Action="http://docs.oasis-open.org/wsn/bw-2/NotificationProducer/GetCurrentMessageRequest", Name="MultipleTopicsSpecifiedFault", Namespace="http://docs.oasis-open.org/wsn/b-2")]
    [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
...
public interface ICreatePullPoint
{
    ...
    [System.ServiceModel.FaultContractAttribute(typeof(UnableToCreatePullPointFaultType), Action="*", Name="UnableToCreatePullPointFault", Namespace="http://docs.oasis-open.org/wsn/b-2")]
    [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
...
public interface SubscriptionManager
{
    ...
    [System.ServiceModel.FaultContractAttribute(typeof(ResourceUnknownFaultType), Action="*", Name="ResourceUnknownFault", Namespace="http://docs.oasis-open.org/wsrf/r-2")]
    [System.ServiceModel.FaultContractAttribute(typeof(UnacceptableTerminationTimeFaultType), Action="*", Name="UnacceptableTerminationTimeFault", Namespace="http://docs.oasis-open.org/wsn/b-2")]
    [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
    ...
    [System.ServiceModel.FaultContractAttribute(typeof(ResourceUnknownFaultType), Action="*", Name="ResourceUnknownFault", Namespace="http://docs.oasis-open.org/wsrf/r-2")]
    [System.ServiceModel.FaultContractAttribute(typeof(UnableToDestroySubscriptionFaultType), Action="*", Name="UnableToDestroySubscriptionFault", Namespace="http://docs.oasis-open.org/wsn/b-2")]
    [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
...
public interface PausableSubscriptionManager
{
    ...
    // CODEGEN: Generating message contract since the operation Unsubscribe is neither RPC nor document wrapped.
    [System.ServiceModel.OperationContractAttribute(Action="http://docs.oasis-open.org/wsn/bw-2/PausableSubscriptionManager/UnsubscribeRequest", ReplyAction="*")]
    [System.ServiceModel.FaultContractAttribute(typeof(ResourceUnknownFaultType), Action="http://docs.oasis-open.org/wsn/bw-2/PausableSubscriptionManager/UnsubscribeRequest", Name="ResourceUnknownFault", Namespace="http://docs.oasis-open.org/wsrf/r-2")]
    [System.ServiceModel.FaultContractAttribute(typeof(UnableToDestroySubscriptionFaultType), Action="http://docs.oasis-open.org/wsn/bw-2/PausableSubscriptionManager/UnsubscribeRequest", Name="UnableToDestroySubscriptionFault", Namespace="http://docs.oasis-open.org/wsn/b-2")]
    [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
    UnsubscribeResponse1 Unsubscribe(UnsubscribeRequest request);
    
    // CODEGEN: Generating message contract since the operation PauseSubscription is neither RPC nor document wrapped.
    [System.ServiceModel.OperationContractAttribute(Action="http://docs.oasis-open.org/wsn/bw-2/PausableSubscriptionManager/PauseSubscriptionRequest", ReplyAction="*")]
    [System.ServiceModel.FaultContractAttribute(typeof(ResourceUnknownFaultType), Action="http://docs.oasis-open.org/wsn/bw-2/PausableSubscriptionManager/PauseSubscriptionRequest", Name="ResourceUnknownFault", Namespace="http://docs.oasis-open.org/wsrf/r-2")]
    [System.ServiceModel.FaultContractAttribute(typeof(PauseFailedFaultType), Action="http://docs.oasis-open.org/wsn/bw-2/PausableSubscriptionManager/PauseSubscriptionRequest", Name="PauseFailedFault", Namespace="http://docs.oasis-open.org/wsn/b-2")]
    [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
    ...
    [System.ServiceModel.OperationContractAttribute(Action="http://docs.oasis-open.org/wsn/bw-2/PausableSubscriptionManager/ResumeSubscriptionRequest", ReplyAction="*")]
    [System.ServiceModel.FaultContractAttribute(typeof(ResourceUnknownFaultType), Action="http://docs.oasis-open.org/wsn/bw-2/PausableSubscriptionManager/ResumeSubscriptionRequest", Name="ResourceUnknownFault", Namespace="http://docs.oasis-open.org/wsrf/r-2")]
    [System.ServiceModel.FaultContractAttribute(typeof(ResumeFailedFaultType), Action="http://docs.oasis-open.org/wsn/bw-2/PausableSubscriptionManager/ResumeSubscriptionRequest", Name="ResumeFailedFault", Namespace="http://docs.oasis-open.org/wsn/b-2")]
    [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
