                    ...
                    new FunctionalityItem[]
                        {
                            ...
                            new FunctionalityItem(){Functionality = Functionality.GetAudioDecoderConfiguration, Path = GetProfileFeaturesPath(AUDIOSTREAMING), Features = new Feature[]{Feature.MediaService, Feature.Audio}},
                            new FunctionalityItem(){Functionality = Functionality.GetAudioDecoderConfigurations, Path = GetProfileFeaturesPath(AUDIOSTREAMING), Features = new Feature[]{Feature.MediaService, Feature.Audio}},
                            ...
                            new FunctionalityItem(){Functionality = Functionality.AddAudioDecoderConfiguration, Path = GetProfileFeaturesPath(AUDIOSTREAMING), Features = new Feature[]{Feature.MediaService, Feature.Audio}},
                            ...
                            new FunctionalityItem(){Functionality = Functionality.RemoveAudioDecoderConfiguration, Path = GetProfileFeaturesPath(AUDIOSTREAMING), Features = new Feature[]{Feature.MediaService, Feature.Audio}},
                            ...
                            new FunctionalityItem(){Functionality = Functionality.GetCompatibleAudioDecoderConfigurations, Path = GetProfileFeaturesPath(AUDIOSTREAMING), Features = new Feature[]{Feature.MediaService, Feature.Audio}},
                            ...
                            new FunctionalityItem(){Functionality = Functionality.GetAudioOutputs, Path = GetProfileFeaturesPath(AUDIOSTREAMING), Features = new Feature[]{Feature.MediaService, Feature.Audio}},
                            // Multicast
