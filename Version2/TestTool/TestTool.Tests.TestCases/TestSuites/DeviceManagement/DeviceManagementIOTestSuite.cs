...
namespace TestTool.Tests.TestCases.TestSuites
{
    ...
    class DeviceManagementIOTestSuite: Base.DeviceManagementTest
    {
        ...
        void ValidateRelayOutputSettings(RelayOutputSettings expected, RelayOutputSettings actual)
        {
            ...
            try
            {
                TimeSpan expectedDelayTime = System.Xml.XmlConvert.ToTimeSpan(expected.DelayTime);
                TimeSpan actualDelayTime = System.Xml.XmlConvert.ToTimeSpan(actual.DelayTime);

                if (expectedDelayTime != actualDelayTime)
                {
            ...
            {
                ok = false;
                dump.AppendLine("DelayTime conversion failed");
            }
