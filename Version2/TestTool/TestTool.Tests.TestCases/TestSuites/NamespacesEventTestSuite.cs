    ...
    public class NamespacesEventTestSuite : Base.EventTest
    {
        ...
        void SubscribeTestWithTransformation(XmlTransformation transformation)
        {
            ...
            () =>
            {
                ...
                subscriptionReference = Subscribe(out exc11, out exc12, ref terminationTime);
        ...
        EndpointReferenceType Subscribe(out FaultException exc1, out FaultException exc2, ref int terminationTime)
        {
            ...
            return response1.SubscriptionReference;
        }
