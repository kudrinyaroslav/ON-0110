...
namespace TestTool.Tests.TestCases.TestSuites
{
    ...
    delegate bool ValidateNotificationMessageFunction(XmlElement topicElement, NotificationMessageHolderType notification,
                                                      MessageCheckSettings settings, StringBuilder logger);
