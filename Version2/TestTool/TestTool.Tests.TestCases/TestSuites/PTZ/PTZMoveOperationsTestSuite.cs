        ...
        public void AbsoluteMoveTest()
        {
            RunTest(() =>
            {
                ...
                if (pantiltSpace != null)
                {
                    ...
                    {
                        pantilt.PanTilt.x = profile.PTZConfiguration.PanTiltLimits.Range.XRange.Max;
                        pantilt.PanTilt.y = profile.PTZConfiguration.PanTiltLimits.Range.YRange.Max;
                    }
                ...
                if (zoomSpace != null)
                {
                    ...
                    {
                        zoom.Zoom.x = profile.PTZConfiguration.ZoomLimits.Range.XRange.Max;
                    }
