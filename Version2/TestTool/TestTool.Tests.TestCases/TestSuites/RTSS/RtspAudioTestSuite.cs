...
namespace TestTool.Tests.TestCases.TestSuites
{
    ...
    class RtspAudioTestSuite : RtspTestSuite
    {
        ...
        public void NvtMediaStreamingG711RtpUnicastUdp()
        {
            ...
            () =>
            {
                MediaUri streamUri = GetG711MediaUri2(StreamType.RTPUnicast, TransportProtocol.UDP, changeLog);
                ValidateStreamSequence2(true, false, false);
        ...
        public void NvtMediaStreamingG711RtpUnicastRtspHttpTcp()
        {
            ...
            () =>
            {
                MediaUri streamUri = GetG711MediaUri2(StreamType.RTPUnicast, TransportProtocol.HTTP, changeLog);
                ValidateStreamSequence2(true, false, false);
                //ValidateAudioSequence();
            },
            () =>
        ...
        public void NvtMediaStreamingG711RtpRtspTcp()
        {
            ...
            () =>
            {
                MediaUri streamUri = GetG711MediaUri2(StreamType.RTPUnicast, TransportProtocol.RTSP, changeLog);
                ValidateStreamSequence2(true, false, false);
                //ValidateAudioSequence();
            },
            () =>
        ...
        public void NvtMediaStreamingAACRtpUnicastUdp()
        {
            ...
            RunTest(
                () =>
                {
                    MediaUri streamUri = GetAACMediaUri2(StreamType.RTPUnicast, TransportProtocol.UDP, changeLog);
                    ValidateStreamSequence2(true, false, false);
                    //ValidateAudioSequence();
                },
                () =>
        ...
        public void NvtMediaStreamingAACRtpUnicastRtspHttpTcp()
        {
            ...
            () =>
            {
                MediaUri streamUri = GetAACMediaUri2(StreamType.RTPUnicast, TransportProtocol.HTTP, changeLog);
                ValidateStreamSequence2(true, false, false);
                //ValidateAudioSequence();
            },
            () =>
        ...
        public void NvtMediaStreamingAACRtpRtspTcp()
        {
            ...
            RunTest(
                () =>
                {
                    MediaUri streamUri = GetAACMediaUri2(StreamType.RTPUnicast, TransportProtocol.RTSP, changeLog);
                    ValidateStreamSequence2(true, false, false);
                    //ValidateAudioSequence();
                },
                () =>
        ...
        public void NvtMediaStreamingG726RtpUnicastUdp()
        {
            ...
            () =>
            {
                MediaUri streamUri = GetG726MediaUri2(StreamType.RTPUnicast, TransportProtocol.UDP, changeLog);
                ValidateStreamSequence2(true, false, false);
                //ValidateAudioSequence();
            },
            () =>
        ...
        public void NvtMediaStreamingG726RtpUnicastRtspHttpTcp()
        {
            ...
            () =>
            {
                MediaUri streamUri = GetG726MediaUri2(StreamType.RTPUnicast, TransportProtocol.HTTP, changeLog);
                ValidateStreamSequence2(true, false, false);
                //ValidateAudioSequence();
            },
            () =>
        ...
        public void NvtMediaStreamingG726RtpRtspTcp()
        {
            ...
            () =>
            {
                MediaUri streamUri = GetG726MediaUri2(StreamType.RTPUnicast, TransportProtocol.RTSP, changeLog);
                ValidateStreamSequence2(true, false, false);
                //ValidateAudioSequence();
            },
            () =>
        ...
        void StreamingSetup2(ref Profile profile, AudioEncoderConfigurationOptions audioOptions,
                            AudioEncoding encoding, TransportProtocol protocol,
                            StreamType streamType, IPType? multicastAddressType,
                            MediaConfigurationChangeLog changeLog)
        {
        ...
        public void AudioStreamingG711RtpUnicastUdp()
        {
            ...
            () =>
            {
                ...
                // stream setup
                StreamingSetup2(ref profile, audioOptions, 
