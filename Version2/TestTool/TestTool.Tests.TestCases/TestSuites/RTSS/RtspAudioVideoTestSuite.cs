...
namespace TestTool.Tests.TestCases.TestSuites
{
    ...
    class RtspAudioVideoTestSuite : RtspTestSuite
    {
        ...
        public void NvtMediaStreamingJpegG711RtpUnicastRtspHttpTcp()
        {
            ...
            RunTest(() =>
            {
                MediaUri streamUri = GetJpegG711MediaUri2(StreamType.RTPUnicast, TransportProtocol.HTTP, changeLog);
                ValidateStreamSequence2(true, false, true);
                //ValidateAudioVideoSequence();
            },
            () =>
        ...
        public void NvtMediaStreamingJpegG711RtpRtspTcp()
        {
            ...
            RunTest(() =>
            {
                MediaUri streamUri = GetJpegG711MediaUri2(StreamType.RTPUnicast, TransportProtocol.RTSP, changeLog);
                ValidateStreamSequence2(true, false, true);
                //ValidateAudioVideoSequence();
            },
            () =>
        ...
        public void NvtMediaStreamingJpegG726RTPUnicastUdp()
        {
            ...
            RunTest(() =>
            {
                MediaUri streamUri = GetJpegG726MediaUri2(StreamType.RTPUnicast, TransportProtocol.UDP, changeLog);
                ValidateStreamSequence2(true, false, true);
                //ValidateAudioVideoSequence();
            },
            () =>
        ...
        public void NvtMediaStreamingJpegG726RtpUnicastRtspHttpTcp()
        {
            ...
            RunTest(() =>
            {
                MediaUri streamUri = GetJpegG726MediaUri2(StreamType.RTPUnicast, TransportProtocol.HTTP, changeLog);
                ValidateStreamSequence2(true, false, true);
                //ValidateAudioVideoSequence();
            },
            () =>
        ...
        public void NvtMediaStreamingJpegG726RtpRtspTcp()
        {
            ...
            RunTest(() =>
                {
                    MediaUri streamUri = GetJpegG726MediaUri2(StreamType.RTPUnicast, TransportProtocol.RTSP, changeLog);
                    ValidateStreamSequence2(true, false, true);
                    //ValidateAudioVideoSequence();
                },
                () =>
        ...
        public void NvtMediaStreamingJpegAacRtpUnicastUdp()
        {
            ...
            RunTest(() =>
            {
                MediaUri streamUri = GetJpegAacMediaUri2(StreamType.RTPUnicast, TransportProtocol.UDP, changeLog);
                ValidateStreamSequence2(true, false, true);
                //ValidateAudioVideoSequence();
            },
            () =>
        ...
        public void NvtMediaStreamingJpegAacRtpUnicastRtspHttpTcp()
        {
            ...
            RunTest(() =>
            {
                MediaUri streamUri = GetJpegAacMediaUri2(StreamType.RTPUnicast, TransportProtocol.HTTP, changeLog);
                ValidateStreamSequence2(true, false, true);
                //ValidateAudioVideoSequence();
            },
            () =>
        ...
        public void NvtMediaStreamingJpegAacRtpRtspTcp()
        {
            ...
            RunTest(() =>
            {
                MediaUri streamUri = GetJpegAacMediaUri2(StreamType.RTPUnicast, TransportProtocol.RTSP, changeLog);
                ValidateStreamSequence2(true, false, true);
                //ValidateAudioVideoSequence();
            },
            () =>
        ...
        public void NvtMediaStreamingJpegG711RtpMulticastUdpIPv4()
        {
            ...
            RunTest(() =>
            {
                MediaUri streamUri = GetJpegG711MediaUri2(StreamType.RTPMulticast, TransportProtocol.UDP, IPType.IPv4, changeLog);
                ValidateStreamSequence2(true, false, true);
                //ValidateAudioVideoSequence();
            },
            () =>
        ...
        public void NvtMediaStreamingJpegG711RtpMulticastUdpIPv6()
        {
            ...
            RunTest(() =>
            {
                MediaUri streamUri = GetJpegG711MediaUri2(StreamType.RTPMulticast, TransportProtocol.UDP, IPType.IPv6, changeLog);
                ValidateStreamSequence2(true, false, true);
                //ValidateAudioVideoSequence();
            },
            () =>
        ...
        public void NvtMediaStreamingJpegG726RtpMulticastUdpIPv4()
        {
            ...
            RunTest(() =>
            {
                MediaUri streamUri = GetJpegG726MediaUri2(StreamType.RTPMulticast, TransportProtocol.UDP, IPType.IPv4, changeLog);
                ValidateStreamSequence2(true, false, true);
                //ValidateAudioVideoSequence();
            },
            () =>
        ...
        public void NvtMediaStreamingJpegG726RtpMulticastUdpIPv6()
        {
            ...
            RunTest(() =>
            {
                MediaUri streamUri = GetJpegG726MediaUri2(StreamType.RTPMulticast, TransportProtocol.UDP, IPType.IPv6, changeLog);
                ValidateStreamSequence2(true, false, true);
                //ValidateAudioVideoSequence();
            },
            () =>
        ...
        public void NvtMediaStreamingJpegAACRtpMulticastUdpIPv4()
        {
            ...
            RunTest(() =>
            {
                MediaUri streamUri = GetJpegAACMediaUri2(StreamType.RTPMulticast, TransportProtocol.UDP, IPType.IPv4, changeLog);
                ValidateStreamSequence2(true, false, true);
                //ValidateAudioVideoSequence();
            },
            () =>
        ...
        public void NvtMediaStreamingJpegAACRtpMulticastUdpIPv6()
        {
            ...
            RunTest(() =>
            {
                MediaUri streamUri = GetJpegAACMediaUri2(StreamType.RTPMulticast, TransportProtocol.UDP, IPType.IPv6, changeLog);
                ValidateStreamSequence2(true, false, true);
                //ValidateAudioVideoSequence();
            },
            () =>
