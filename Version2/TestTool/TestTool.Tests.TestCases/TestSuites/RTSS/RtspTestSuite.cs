...
using TestTool.Tests.Common.TestEngine; // quick hack
...
namespace TestTool.Tests.TestCases.TestSuites
{
    class RtspTestSuite : RTSSTestSuite
    {
        ...
        MediaUri GetVideoMediaUri2(TestVideoEncoderConfigurationOptions test,
            CopyVideoEncoderConfiguration copyMethod,
            string profileRequirementsDescription,
            VideoEncoding encoding,
            TransportProtocol protocol,
            ...
            MediaConfigurationChangeLog changeLog)
        {
          ...
          UsedProfileToken = profile.token;
          MediaUri streamUri = GetStreamUri(streamSetup, profile.token);
          AdjustVideo2(protocol, streamType, streamUri, profile.VideoEncoderConfiguration);
        ...
        MediaUri GetVideoMediaUri2(TestVideoEncoderConfigurationOptions test,
            ...
            MediaConfigurationChangeLog changeLog)
        {
          return GetVideoMediaUri2(test, copyMethod, profileRequirementsDescription, encoding, protocol, streamType, null, changeLog);
        }
            ...
            VideoEncoderConfiguration conf)
        {
          ...
          VideoUtils.AdjustGeneral2(NewGenVideo, _username, _password, _messageTimeout, protocol, streamType, streamUri);
          VideoUtils.AdjustVideo2(NewGenVideo, conf);
        }
        protected void AdjustVideoAndAudio2(
            TransportProtocol protocol,
            StreamType streamType,
            MediaUri streamUri,
            VideoEncoderConfiguration confV,
            AudioEncoderConfiguration confA)
        {
          if (NewGenVideo == null)
          {
            NewGenVideo = new VideoContainer2();
          ...
          VideoUtils.AdjustGeneral2(NewGenVideo, _username, _password, _messageTimeout, protocol, streamType, streamUri);
          VideoUtils.AdjustVideo2(NewGenVideo, confV);
          VideoUtils.AdjustAudio2(NewGenVideo, confA);
        }
        protected void AdjustAudio2(
            TransportProtocol protocol,
            StreamType streamType,
            MediaUri streamUri,
            AudioEncoderConfiguration confA)
        ...
        public void ValidateStreamSequence2(bool CheckAudio, bool CheckSync, bool CheckVideo)
        {
          ...
          NewGenVideo.SetSequence(Sequence, OperationDelay);
          NewGenVideo.Connect();
        ...
        MediaUri GetAudioVideoMediaUri2(TestVideoEncoderConfigurationOptions videoTest,
            string videoCodec,
            VideoEncoding encoding,
            TestAudioEncoderConfigurationOptions audioTest,
            string audioCodec,
            ...
            MediaConfigurationChangeLog changeLog)
        {
          ...
          UsedProfileToken = profile.token;
          MediaUri streamUri = GetStreamUri(streamSetup, profile.token);
          AdjustVideoAndAudio2(protocol, streamType, streamUri, profile.VideoEncoderConfiguration, profile.AudioEncoderConfiguration);
        ...
        protected MediaUri GetJpegMediaUri2(StreamType streamType, TransportProtocol protocol,
            MediaConfigurationChangeLog changeLog)
        {
          return GetVideoMediaUri2(
              (options) => { return (options.JPEG != null); },
              (profile, options) => { AdjustJPEGVideoEncoderConfiguration(profile, options); },
              "JPEG",
              VideoEncoding.JPEG,
        ...
        protected MediaUri GetMpeg4MediaUri2(StreamType streamType, TransportProtocol protocol,
            MediaConfigurationChangeLog changeLog)
        {
          return GetVideoMediaUri2(
              (options) => { return (options.MPEG4 != null); },
        ...
        protected MediaUri GetH264MediaUri2(StreamType streamType, TransportProtocol protocol,
            MediaConfigurationChangeLog changeLog)
        {
          return GetVideoMediaUri2(
              (options) => { return (options.H264 != null); },
        ...
        protected MediaUri GetJpegG711MediaUri2(StreamType streamType, TransportProtocol protocol,
            MediaConfigurationChangeLog changeLog)
        {
          return GetAudioVideoMediaUri2((options) => { return (options.JPEG != null); },
              "JPEG",
              VideoEncoding.JPEG,
              options => (CheckAudioSupport(options, AudioEncoding.G711)),
              "G.711",
        ...
        protected MediaUri GetJpegG726MediaUri2(StreamType streamType, TransportProtocol protocol,
            MediaConfigurationChangeLog changeLog)
        {
          return GetAudioVideoMediaUri2(options => (options.JPEG != null),
              "JPEG",
              VideoEncoding.JPEG,
              options => (CheckAudioSupport(options, AudioEncoding.G726)),
              "G.726",
        ...
        protected MediaUri GetJpegAacMediaUri2(StreamType streamType, TransportProtocol protocol,
            MediaConfigurationChangeLog changeLog)
        {
          return GetAudioVideoMediaUri2(options => (options.JPEG != null),
              "JPEG",
        ...
        protected MediaUri GetJpegMediaUri2(StreamType streamType, TransportProtocol protocol, IPType addressType, MediaConfigurationChangeLog changeLog)
        {
          return GetVideoMediaUri2(
              (options) => { return (options.JPEG != null); },
              (profile, options) => { },
        ...
        protected MediaUri GetMpeg4MediaUri2(StreamType streamType, TransportProtocol protocol, IPType addressType, MediaConfigurationChangeLog changeLog)
        {
          return GetVideoMediaUri2(
              (options) => { return (options.MPEG4 != null); },
              (profile, options) =>
        ...
        protected MediaUri GetH264MediaUri2(StreamType streamType, TransportProtocol protocol, IPType addressType, MediaConfigurationChangeLog changeLog)
        {
          return GetVideoMediaUri2(
              (options) => { return (options.H264 != null); },
              (profile, options) =>
        ...
        protected MediaUri GetJpegG711MediaUri2(StreamType streamType, TransportProtocol protocol, IPType addressType, MediaConfigurationChangeLog changeLog)
        {
          return GetAudioVideoMediaUri2(
              (options) => { return (options.JPEG != null); },
              "JPEG",
        ...
        protected MediaUri GetJpegAACMediaUri2(StreamType streamType, TransportProtocol protocol, IPType addressType, MediaConfigurationChangeLog changeLog)
        {
          return GetAudioVideoMediaUri2(
              (options) => { return (options.JPEG != null); },
              "JPEG",
        ...
        protected MediaUri GetJpegG726MediaUri2(StreamType streamType, TransportProtocol protocol, IPType addressType, MediaConfigurationChangeLog changeLog)
        {
          return GetAudioVideoMediaUri2(
              (options) => { return (options.JPEG != null); },
              "JPEG",
            ...
            IPType? multicastAddressType, MediaConfigurationChangeLog changeLog)
        {
          ...
          UsedProfileToken = profile.token;
          MediaUri streamUri = GetStreamUri(streamSetup, profile.token);
          AdjustAudio2(protocol, streamType, streamUri, profile.AudioEncoderConfiguration);
        ...
        protected MediaUri GetG711MediaUri2(StreamType streamType, TransportProtocol protocol, MediaConfigurationChangeLog changeLog)
        {
          return GetAudioMediaUri2(
              options => (CheckAudioSupport(options, AudioEncoding.G711)),
              "G.711",
              AudioEncoding.G711,
              streamType,
        ...
        protected MediaUri GetAACMediaUri2(StreamType streamType, TransportProtocol protocol, MediaConfigurationChangeLog changeLog)
        {
          return GetAudioMediaUri2(
              options => (CheckAudioSupport(options, AudioEncoding.AAC)),
              "AAC",
        ...
        protected MediaUri GetG726MediaUri2(StreamType streamType, TransportProtocol protocol, MediaConfigurationChangeLog changeLog)
        {
          return GetAudioMediaUri2(
              options => (CheckAudioSupport(options, AudioEncoding.G726)),
              "G.726",
