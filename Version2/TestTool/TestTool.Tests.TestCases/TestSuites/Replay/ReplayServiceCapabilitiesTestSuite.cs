...
namespace TestTool.Tests.TestCases.TestSuites
{
    ...
    public class ReplayServiceCapabilitiesTestSuite : DeviceManagementTest
    {
        ...
        [Test(Name = "GET SERVICES AND GET REPLAY SERVICE CAPABILITIES CONSISTENCY",
            Order = "01.01.02",
            Id = "1-1-2",
            Category = Category.REPLAY,
            Path = PATH,
            ...
            RequirementLevel = RequirementLevel.Must,
            RequiredFeatures = new Feature[] { Feature.GetServices, Feature.ReplayService },
            FunctionalityUnderTest = new Functionality[] { Functionality.GetReplayServiceCapabilities, Functionality.GetServices })]
