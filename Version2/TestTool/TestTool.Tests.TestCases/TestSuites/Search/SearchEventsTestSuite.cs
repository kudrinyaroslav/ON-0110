...
namespace TestTool.Tests.TestCases
{
    ...
    public partial class SearchEventsTestSuite : Base.SearchTest
    {
        ...
        [Test(Name = "FIND EVENTS – FORWARD AND BACKWARD SEARCH (SEARCH ENDPOINTS EQUAL TO RECORDING ENDPOINTS)",
           ...
           Version = 2.0 ,
           RequiredFeatures = new Feature[] { Feature.RecordingControlService, Feature.RecordingSearchService },
        ...
        {
            CommonForwardBackwardSearchEventsTest(DefineSearchRange, false, true, false);
        }
        ...
        {
            CommonForwardBackwardSearchEventsTest(DefineSearchRangeOutside, false, true, true);
        }
