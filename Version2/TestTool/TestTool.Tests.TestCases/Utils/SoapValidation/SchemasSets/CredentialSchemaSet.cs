...
{
    public class CredentialSchemaSet: BaseSchemaSet
    {
                /// <summary>
        /// Instance
        /// </summary>
        private static CredentialSchemaSet _instance;

        /// <summary>
        /// Gets instance (if instance has not been created - creates it).
        /// </summary>
        /// <returns>RecordingSchemasSet</returns>
        public static CredentialSchemaSet GetInstance()
        {
            if (_instance == null)
            {
                _instance = new CredentialSchemaSet();
            }
